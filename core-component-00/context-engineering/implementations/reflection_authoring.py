...
2026-07-16, after two rounds of implementation + adversarial review):
    ...
    supporting/03-deployment-guidelines.md's revised Phase 1 "done" gate
    and supporting/audits/mistake-log.md's MISTAKE-2026-07-16-001 for the
    full reasoning behind this pivot. Nothing below changes that.
