...
core-component-00/mcp-servers/agent-memory/write_provenance.py.
...
Run with:
    python -m pytest core-component-00/mcp-servers/agent-memory/tests/test_write_provenance.py -v
"""
