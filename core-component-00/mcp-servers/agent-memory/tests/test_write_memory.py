"""
Executable pytest suite for core-component-00/mcp-servers/agent-memory/write_tool.py
...
Run with (from this directory's mcp-servers/agent-memory venv):
    python -m pytest core-component-00/mcp-servers/agent-memory/tests/test_write_memory.py -v
