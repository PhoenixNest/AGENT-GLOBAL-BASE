"""
Executable pytest suite for core-component-00/mcp-servers/agent-memory/write_gate.py.
...
Run with (from this directory, or from core-component-00/mcp-servers/agent-memory/):
    python -m pytest core-component-00/mcp-servers/agent-memory/tests/test_write_gate.py -v
