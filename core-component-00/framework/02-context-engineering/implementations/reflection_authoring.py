...
# core-component-00/platform/model-context-protocol-servers/_shared/models/<slug>/, slug = "/" -> "--".
...
def _shared_model_dir() -> Path:
    # core-component-00/framework/02-context-engineering/implementations/ -> core-component-00/
    return (
...
def _load_shared_embedder(
    ...
    if not resolved_dir.is_dir() or not any(resolved_dir.iterdir()):
        print(
            ...
            "provisioned (core-component-00/platform/model-context-protocol-servers/_shared/provision_model.py "
