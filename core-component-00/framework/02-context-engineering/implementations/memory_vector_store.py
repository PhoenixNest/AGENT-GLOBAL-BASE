...
_HARNESS_ENGINEERING_ROOT = Path(__file__).resolve().parents[2] / "03-harness-engineering"
...
class JSONLMemoryLog:
    ...
    semantic/procedural, mirroring:
        ...
        core-component-00/framework/02-context-engineering/memory/
...
def _load_rag_bm25():
    ...
    rag_retrieval_path = (
        ...
        / "framework" / "04-retrieval-augmented-generation" / "implementations" / "retrieval.py"
    )
