# core-component-00/framework/02-context-engineering/ — Layer 2: Context Engineering
...
```python
import sys
sys.path.insert(0, "path/to/core-component-00/framework/02-context-engineering")
