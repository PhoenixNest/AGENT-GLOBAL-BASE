...
**See also:** [Assembly Patterns](./assembly-patterns.md) · [context_assembler.py](core-component-00/framework/02-context-engineering/implementations/context_assembler.py) · [Memory Types](core-component-00/framework/02-context-engineering/fundamentals/memory-types.md)
