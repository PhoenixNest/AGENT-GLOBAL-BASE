...
- [Harness Engineering — Token Budget Management](core-component-00/framework/03-harness-engineering/implementations/context_monitor.py)
- [RAG Architecture Overview](core-component-00/framework/04-retrieval-augmented-generation/architecture/overview.md)
- [Prompt Engineering Fundamentals](core-component-00/framework/01-prompt-engineering/fundamentals/research.md)
