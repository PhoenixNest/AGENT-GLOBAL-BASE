...
> [Phase-Adaptive Index Sync Hook pattern](core-component-00/framework/04-retrieval-augmented-generation/patterns/index-sync-hooks.md) —
...
[pattern document](core-component-00/framework/04-retrieval-augmented-generation/patterns/index-sync-hooks.md#operator-control-interface) are
...
See `core-component-00/framework/04-retrieval-augmented-generation/evaluation/reference-table.md`
...
**File:** `core-component-00/platform/model-context-protocol-servers/workspace-knowledge/rag-system/rag-sync-state.json`
...
See `core-component-00/framework/04-retrieval-augmented-generation/deployment/lightweight/reference/rag-sync-state-schema.md`
...
$stateFile = "core-component-00\platform\model-context-protocol-servers\workspace-knowledge\rag-system\rag-sync-state.json"
...
| **Orphaned Point Remediation** | `core-component-00/framework/04-retrieval-augmented-generation/evaluation/reference-table.md` §Orphaned Point Detection   |
