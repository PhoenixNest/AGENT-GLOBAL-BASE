...
> [Phase-Adaptive Index Sync Hook pattern](core-component-00/framework/04-retrieval-augmented-generation/patterns/index-sync-hooks.md) as deployed
...
`core-component-00/framework/04-retrieval-augmented-generation/deployment/lightweight/guides/hook-configuration.md`
§Switching Backends.
...
```powershell
Get-Content "core-component-00\platform\model-context-protocol-servers\workspace-knowledge\rag-system\rag-sync-state.json" | ConvertFrom-Json
```
...
| Resource                     | Location                                                                                               |
| ---------------------------- | ------------------------------------------------------------------------------------------------------ |
| **Hook Configuration Guide** | `core-component-00/framework/04-retrieval-augmented-generation/deployment/lightweight/guides/hook-configuration.md` |
