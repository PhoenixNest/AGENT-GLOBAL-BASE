# core-component-00/framework/04-retrieval-augmented-generation/ — Layer 4: RAG
...
```
core-component-00/platform/model-context-protocol-servers/workspace-knowledge/
```
