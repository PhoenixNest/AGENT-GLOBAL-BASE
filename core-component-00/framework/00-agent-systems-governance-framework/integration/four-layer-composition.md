...
**Reference:** `core-component-00/framework/02-context-engineering/implementations/context_assembler.py`
...
**Reference:** `core-component-00/framework/01-prompt-engineering/patterns/advanced-patterns.md`
...
- [Foundational Paper](core-component-00/framework/00-agent-systems-governance-framework/CONCEPTS.md) — Convergence thesis
- [Compliance Standard](core-component-00/framework/00-agent-systems-governance-framework/governance/compliance-standard.md) — Per-layer requirements
- [Context Assembler](core-component-00/framework/02-context-engineering/implementations/context_assembler.py)
- [Harness Error Boundary](core-component-00/framework/03-harness-engineering/implementations/error_boundary.py)
- [Token Budget Monitor](core-component-00/framework/03-harness-engineering/implementations/context_monitor.py)
- [Handoff Packet](core-component-00/framework/05-multi-agent-engineering/implementations/handoff_packet.py)
- [RAG Architecture](core-component-00/framework/04-retrieval-augmented-generation/architecture/overview.md)
