...
- `core-component-00/framework/03-harness-engineering/patterns/prompt-templates.md` — Error boundary
  prompts that reference this severity vocabulary
- `core-component-00/framework/05-multi-agent-engineering/patterns/orchestration-patterns.md` —
