...
- `core-component-00/framework/01-prompt-engineering/patterns/advanced-patterns.md` — Techniques
  for making behavioural constraints effective in system prompts
- `core-component-00/framework/03-harness-engineering/` — Harness-level gate verification
- `core-component-00/framework/05-multi-agent-engineering/patterns/anti-patterns.md` — System-level
