...
- `core-component-00/framework/01-prompt-engineering/` — Patterns for writing canonical agent identities
- `core-component-00/framework/02-context-engineering/patterns/multi-agent-handoff.md` — How canonical
