...
> [`core-component-00/framework/00-agent-systems-governance-framework/governance/maturity-model.md`](core-component-00/framework/00-agent-systems-governance-framework/governance/maturity-model.md)
...
- [Agent Systems Governance Framework — Convergence of Four Disciplines](core-component-00/framework/00-agent-systems-governance-framework/CONCEPTS.md)
...
- [Context Handoff Protocol](core-component-00/framework/02-context-engineering/patterns/multi-agent-handoff.md)
- [Context Assembler](core-component-00/framework/02-context-engineering/implementations/context_assembler.py)
- [Error Boundary](core-component-00/framework/03-harness-engineering/implementations/error_boundary.py)
