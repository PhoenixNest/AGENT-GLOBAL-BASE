...
**See also:** [Orchestration Patterns](./orchestration-patterns.md) · [Quick Reference](core-component-00/framework/05-multi-agent-engineering/quick-reference.md) · [CONCEPTS.md](core-component-00/framework/05-multi-agent-engineering/CONCEPTS.md)
