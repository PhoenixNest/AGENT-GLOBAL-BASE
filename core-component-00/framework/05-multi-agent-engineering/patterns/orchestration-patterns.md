...
**See also:** [Swarm Topologies](core-component-00/framework/05-multi-agent-engineering/fundamentals/swarm-topologies.md) · [Anti-Patterns](./anti-patterns.md) · [Swarm Orchestrator](core-component-00/framework/05-multi-agent-engineering/implementations/swarm_orchestrator.py)
