...
**See also:** [CONCEPTS.md](core-component-00/framework/05-multi-agent-engineering/CONCEPTS.md) · [Orchestration Patterns](core-component-00/framework/05-multi-agent-engineering/patterns/orchestration-patterns.md) · [Quick Reference](core-component-00/framework/05-multi-agent-engineering/quick-reference.md)
