# core-component-00/framework/03-harness-engineering/ — Layer 3: Harness Engineering
...
```python
import sys
sys.path.insert(0, "path/to/core-component-00/framework/03-harness-engineering")
