...
sys.path.insert(0, os.path.join(_CORE00_ROOT, "framework", "02-context-engineering"))
sys.path.insert(0, os.path.join(_CORE00_ROOT, "platform", "model-context-protocol-servers", "_shared"))
