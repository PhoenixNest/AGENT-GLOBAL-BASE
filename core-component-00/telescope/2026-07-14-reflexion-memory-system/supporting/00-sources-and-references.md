...
| 9   | `core-component-00/platform/model-context-protocol-servers/agent-memory/README.md`                                                                                | Current live architecture: 3 Qdrant collections, JSONL-first source of truth, `active → dormant → archived` lifecycle, `sacred` flag, and — critically — the explicit, reasoned absence of a write-capable MCP tool |
