...
| Qdrant instance        | Existing `qdrant-memory` (`localhost:6335`), not a new instance                             | Reflections are a memory type, not a new blast-radius domain — reuses the isolation decision already made in `2026-07-10-agent-memory-architecture/research-report.md` § Architecture Decisions          |
