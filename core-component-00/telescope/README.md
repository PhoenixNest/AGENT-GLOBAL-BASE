...
| `2026-07-13-mcp-embedder-service-redesign` | 2026-07-13 | Approved — implementation plan presented, awaiting sign-off | Root-cause of the agent-memory embedder-loading stall (traced to the MCP host's subprocess-launch path); persistent embedder service approved and CEO delegated full authority to Dr. Vance for implementation + personnel assignment | CEO       |
