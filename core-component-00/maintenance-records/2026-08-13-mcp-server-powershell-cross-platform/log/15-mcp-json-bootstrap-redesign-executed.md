...
Pipeline stage 3 — Execution (`core-component-00/maintenance-records/pipeline.md`).
...
5. Updated `core-component-00/mcp-servers/CLAUDE.md` § Python Environment (the interpreter-table
