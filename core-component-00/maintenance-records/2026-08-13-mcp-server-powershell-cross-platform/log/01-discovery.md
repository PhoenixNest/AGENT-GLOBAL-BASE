...
Pipeline stage 1 — Investigation (`core-component-00/maintenance-records/pipeline.md`).
...
2. Grepped `core-component-00/mcp-servers/` for `powershell|pwsh|PowerShell|\.ps1` (case
...
| Grep sweep of `core-component-00/mcp-servers/` for PowerShell references       | Confirmed 8 matching files (server.py, 2 test files, backup script, 2 READMEs, `.ps1`, CLAUDE.md) |
...
`core-component-00/maintenance-records/CLAUDE.md` (Dr. Vance
