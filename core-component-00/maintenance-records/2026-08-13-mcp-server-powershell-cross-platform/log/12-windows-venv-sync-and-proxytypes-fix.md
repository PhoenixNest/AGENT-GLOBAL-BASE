...
Pipeline stage 3 — Execution (`core-component-00/maintenance-records/pipeline.md`), a new incident
...
6. Added a small vendored compatibility shim,
   `core-component-00/mcp-servers/workspace-knowledge/_vendor/proxytypes.py`, which re-exports
