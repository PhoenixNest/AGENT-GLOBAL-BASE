...
Pipeline stage 3 — Execution (`core-component-00/maintenance-records/pipeline.md`), executing the
...
5. Updated `core-component-00/mcp-servers/CLAUDE.md`'s "Cross-platform consequence" note, which
