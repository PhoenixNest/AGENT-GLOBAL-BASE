...
READMEs — originally documented as running under one shared venv at
`core-component-00/mcp-servers/.venv/`; as of 2026-08-20 (`log/08`) each server runs from its own
per-server venv instead, per CEO-approved architecture decision.
...
**Status:** Completed with one follow-up item open (2026-08-20). Item #1 (`.mcp.json` Windows-only
launch path) closed: applied, foreground-verified, and independently confirmed via a live `/mcp
reconnect` (`log/06`, `log/07`). Item #4 (per-server vs. shared venv architecture) closed: CEO
...
| #   | Item                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Owner                                                             | Target                                                              |
| --- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- | ------------------------------------------------------------------- |
| 1   | **CLOSED 2026-08-20** — ~~The `.mcp.json` portion of the original cross-platform finding...~~ Applied (`log/06-linux-launch-applied-and-verified.md`) and independently confirmed by a live `/mcp reconnect` from the CEO, both servers reconnecting successfully (`log/07-reconnect-independently-confirmed.md`) — satisfies the `pipeline.md` stage 4 independent-review gate.                                                                                                                    | (closed)                                                          | (closed)                                                            |
