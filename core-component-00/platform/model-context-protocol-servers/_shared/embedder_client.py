...
(core-component-00/platform/model-context-protocol-servers/_shared/embedder-service/), used by both
...
_HARNESS_ENGINEERING_ROOT = Path(__file__).resolve().parents[3] / "framework" / "03-harness-engineering"
