"""Executable pytest suite for core-component-00/platform/model-context-protocol-servers/agent-memory/server.py.
...
Run: python -m pytest core-component-00/platform/model-context-protocol-servers/agent-memory/tests/ -v
"""
...
sys.path.insert(
    0, str(Path(__file__).resolve().parents[4] / "framework" / "02-context-engineering")
)
