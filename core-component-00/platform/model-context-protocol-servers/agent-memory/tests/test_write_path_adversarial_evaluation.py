...
Run: python -m pytest core-component-00/platform/model-context-protocol-servers/agent-memory/tests/test_write_path_adversarial_evaluation.py -v
"""
...
class TestAttackShape1DirectInstructionInjection:
    ...
    def test_hook_pair_wired_into_settings_json(self):
        ...
        test's bypass path."""
        settings_path = _AGENT_MEMORY_DIR.parents[3] / ".claude" / "settings.json"
