...
# core-component-00/platform/model-context-protocol-servers/agent-memory/server.py -- a workspace-root-
...
def _cleanup_stale_sibling_processes() -> None:
    ...
    (core-component-00/platform/model-context-protocol-servers/agent-memory/server.py), normalized for
