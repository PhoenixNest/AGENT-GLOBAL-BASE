...
Dependencies install into the **shared** environment at `core-component-00/platform/model-context-protocol-servers/.venv/`,
...
with the shared interpreter. See `../CLAUDE.md` § Python Environment for why.

```
# from the repo root — uv picks the CUDA torch index from pyproject.toml automatically, on any OS
uv pip install -e core-component-00/platform/model-context-protocol-servers/workspace-knowledge
```
...
```bash
# Linux/macOS
core-component-00/platform/model-context-protocol-servers/.venv/bin/python -m pip install -e core-component-00/platform/model-context-protocol-servers/workspace-knowledge
core-component-00/platform/model-context-protocol-servers/.venv/bin/python -m pip install "torch==2.13.0+cu130" --index-url https://download.pytorch.org/whl/cu130
```

```powershell
# Windows
core-component-00\platform\model-context-protocol-servers\.venv\Scripts\python.exe -m pip install -e core-component-00\platform\model-context-protocol-servers\workspace-knowledge
core-component-00\platform\model-context-protocol-servers\.venv\Scripts\python.exe -m pip install "torch==2.13.0+cu130" --index-url https://download.pytorch.org/whl/cu130
```
...
```json
{
  "mcpServers": {
    "workspace-knowledge": {
      "command": "${CLAUDE_PROJECT_DIR:-.}/core-component-00/platform/model-context-protocol-servers/workspace-knowledge/.venv/Scripts/python.exe",
      "args": [
        "${CLAUDE_PROJECT_DIR:-.}/core-component-00/platform/model-context-protocol-servers/workspace-knowledge/server.py"
      ],
      "env": {
...
// response
{
  ...
  "results": [
    {
      "file": "core-component-00/platform/model-context-protocol-servers/workspace-knowledge/README.md",
