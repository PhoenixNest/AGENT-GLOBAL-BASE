# core-component-00/platform/remediation/ — CC-00 Remediation Program

Execution-tracking archive for the Core Component 00 Laboratory. Read this before opening or
updating any Implementation Plan for a gap identified in `core-component-00/platform/benchmarks/`.
...
(`core-component-00/platform/benchmarks/`) — approach, acceptance criteria, test plan, status, and
verification for the gaps severe enough to warrant dedicated tracking. This is distinct from
every other CC-00 record type:

- `core-component-00/platform/benchmarks/` — the point-in-time external comparison that _finds_ a gap.
...
- `core-component-00/platform/maintenance-records/` — operational upkeep of lab infrastructure (servers,
...
`core-component-00/platform/benchmarks/**/enterprise-assessment.md` Severity-Ordered Remediation Plan, or a
...
**Out of scope:** the benchmark assessments themselves (→ `core-component-00/platform/benchmarks/`); P2/P3
...
(→ `core-component-00/platform/maintenance-records/`); ASGF compliance audits
