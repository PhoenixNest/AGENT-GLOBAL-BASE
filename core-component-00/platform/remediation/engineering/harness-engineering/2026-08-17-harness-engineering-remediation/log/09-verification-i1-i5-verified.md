...
1. Re-read `core-component-00/framework/03-harness-engineering/implementations/tool_registry.py`
...
2. Re-read `core-component-00/framework/03-harness-engineering/implementations/error_boundary.py`
