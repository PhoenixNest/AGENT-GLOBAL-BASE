...
Part of `core-component-00/platform/maintenance-records/YYYY-MM-DD-<slug>/maintenance-record.md`. Pipeline
stage [N — Stage Name] (`core-component-00/platform/maintenance-records/pipeline.md`).
...
to if a new problem was found (see `core-component-00/platform/maintenance-records/pipeline.md`'s Reopen
