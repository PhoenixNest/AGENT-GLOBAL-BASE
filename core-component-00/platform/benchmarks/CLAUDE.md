# core-component-00/platform/benchmarks/ — CC-00 Enterprise Benchmark Archive
...
- `core-component-00/platform/maintenance-records/` — operational maintenance history (servers,
...
(→ `core-component-00/platform/maintenance-records/`), and internal ASGF compliance audits
