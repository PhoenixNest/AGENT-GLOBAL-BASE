...
<!-- Copy this file into a NEW FOLDER core-component-00/remediation/engineering/<module-slug>/YYYY-MM-DD-<slug>/
     (or retrieval-augmented-generation/YYYY-MM-DD-<slug>/ for Layer 4) — not into template/ itself
     — per core-component-00/remediation/CLAUDE.md § Directory Structure. This file inside it is
     always named `implementation-plan.md`.

     Governed by core-component-00/remediation/pipeline.md — read it before opening a topic,
     ...
     core-component-00/maintenance-records/template/maintenance-record.md. The full account of
...
- **Backlog items for this layer (P2/P3, not in this plan):** `core-component-00/remediation/README.md` § Remediation Backlog
