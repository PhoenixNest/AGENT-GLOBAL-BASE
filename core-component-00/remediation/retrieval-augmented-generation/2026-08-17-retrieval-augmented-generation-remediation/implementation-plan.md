...
| **Status**                  | Executed, pending verification — see `log/03-execution-i1-executed.md`, `log/04-execution-i2-executed.md`                                              |
