...
1. Re-read `core-component-00/engineering/prompt-engineering/fundamentals/research.md` § 3.7
...
2. Cross-checked § 3.7 against the source benchmark row (Prompt R4,
   `core-component-00/benchmarks/engineering/prompt-engineering/2026-08-16-prompt-engineering-enterprise-assessment/enterprise-assessment.md`,
