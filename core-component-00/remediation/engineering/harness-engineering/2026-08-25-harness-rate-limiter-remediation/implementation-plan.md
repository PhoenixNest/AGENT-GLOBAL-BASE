...
| **Status**                  | Executed, pending verification — see `log/03-execution-i1-executed.md`                                                                       |
