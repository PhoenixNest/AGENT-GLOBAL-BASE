...
Production implementation of `core-component-00/framework/05-multi-agent-engineering/implementations/handoff_packet.py`
...
`core-component-00/framework/02-context-engineering/patterns/multi-agent-handoff.md`.
...
- `core-component-00/framework/02-context-engineering/patterns/multi-agent-handoff.md`
- `core-component-00/framework/05-multi-agent-engineering/implementations/handoff_packet.py`
