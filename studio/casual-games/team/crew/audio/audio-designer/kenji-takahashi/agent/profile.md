...
reports-to: Hiroshi Nakamura (Composer/Sound Director, Contract)
...
# Kenji Takahashi — Audio Designer
...
| Skill                   | Location                       |
| ----------------------- | ------------------------------ |
| `game-sound-design.md`  | `skills/game-sound-design.md`  |
| `audio-middleware.md`   | `skills/audio-middleware.md`   |
| `chiptune-synthesis.md` | `skills/chiptune-synthesis.md` |

## Vetting Record

| Assessment        | Result                    |
| ----------------- | ------------------------- |
| Composite Score   | 4.320/5 (90th percentile) |
| Vetting Score     | 16/20                     |
| Impact at Scale   | 4/5                       |
| Craft Depth       | 5/5                       |
