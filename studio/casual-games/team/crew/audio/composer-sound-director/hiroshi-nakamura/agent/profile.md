...
| Skill                          | Location                              |
| ------------------------------ | ------------------------------------- |
| `chiptune-composition.md`      | `skills/chiptune-composition.md`      |
| `fmod-wwise-integration.md`    | `skills/fmod-wwise-integration.md`    |
| `interactive-music-systems.md` | `skills/interactive-music-systems.md` |
| `audio-pipeline-design.md`     | `skills/audio-pipeline-design.md`     |
