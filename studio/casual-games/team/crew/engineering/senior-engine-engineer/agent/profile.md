...
| Skill                            | Location                                |
| -------------------------------- | --------------------------------------- |
| `cpp-engine-development.md`      | `skills/cpp-engine-development.md`      |
| `memory-physics-optimization.md` | `skills/memory-physics-optimization.md` |

## Vetting Record

| Assessment        | Result                   |
| ----------------- | ------------------------ |
| Composite Score   | 4.42/5 (96th percentile) |
| Vetting Score     | 18/20                    |
| Impact at Scale   | 5/5                      |
| Craft Depth       | 5/5                      |
