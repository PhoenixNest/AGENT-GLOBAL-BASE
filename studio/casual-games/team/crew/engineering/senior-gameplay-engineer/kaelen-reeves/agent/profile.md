---
name: Kaelen Reeves
role: Senior Gameplay Engineer #1
tier: team/teammates
seniority: Senior (L2)
...
# Kaelen Reeves — Senior Gameplay Engineer #1
...
| Skill                             | Location                                 |
| --------------------------------- | ---------------------------------------- |
| `combat-progression-systems.md`   | `skills/combat-progression-systems.md`   |
| `ai-behavior-programming.md`      | `skills/ai-behavior-programming.md`      |
| `mobile-gameplay-optimization.md` | `skills/mobile-gameplay-optimization.md` |

## Vetting Record

| Assessment        | Result                   |
| ----------------- | ------------------------ |
| Composite Score   | 4.27/5 (94th percentile) |
| Vetting Score     | 17/20                    |
| Impact at Scale   | 5/5                      |
| Craft Depth       | 4/5                      |
