...
# Amara Okafor — Senior Gameplay Engineer #2
...
| Skill                            | Location                                |
| -------------------------------- | --------------------------------------- |
| `ui-systems-architecture.md`     | `skills/ui-systems-architecture.md`     |
| `input-animation-integration.md` | `skills/input-animation-integration.md` |

## Vetting Record

| Assessment        | Result                   |
| ----------------- | ------------------------ |
| Composite Score   | 4.31/5 (95th percentile) |
| Vetting Score     | 17/20                    |
| Impact at Scale   | 5/5                      |
| Craft Depth       | 4/5                      |
