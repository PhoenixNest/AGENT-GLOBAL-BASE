...
| Skill                          | Location                              |
| ------------------------------ | ------------------------------------- |
| `backend-abstraction-layer.md` | `skills/backend-abstraction-layer.md` |
| `playfab-anti-cheat.md`        | `skills/playfab-anti-cheat.md`        |

## Vetting Record

| Assessment        | Result                   |
| ----------------- | ------------------------ |
| Composite Score   | 4.38/5 (96th percentile) |
| Vetting Score     | 18/20                    |
| Impact at Scale   | 5/5                      |
| Craft Depth       | 5/5                      |
