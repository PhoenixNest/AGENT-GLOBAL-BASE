...
# Lars Johansson — Rendering Engineer
...
| Skill                          | Location                              |
| ------------------------------ | ------------------------------------- |
| `mobile-rendering-pipeline.md` | `skills/mobile-rendering-pipeline.md` |
| `shader-gpu-optimization.md`   | `skills/shader-gpu-optimization.md`   |

## Vetting Record

| Assessment        | Result                   |
| ----------------- | ------------------------ |
| Composite Score   | 4.25/5 (93rd percentile) |
| Vetting Score     | 17/20                    |
| Impact at Scale   | 5/5                      |
| Craft Depth       | 4/5                      |
