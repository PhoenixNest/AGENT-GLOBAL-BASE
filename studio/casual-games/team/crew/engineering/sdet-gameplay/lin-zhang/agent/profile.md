...
| ---------------------- | --------------------------- | ----------------------------------------------------------------- |
| Mobile Test Automation | `mobile-test-automation.md` | Device farm testing, cross-platform QA, touch input simulation    |
| Bug Tracking & Triage  | `bug-tracking-triage.md`    | Automated defect classification, ML-based triage, quality metrics |
...
**Vetting Result:** PASS | **Background:** CLEAR | **Composite:** 4.480/5 (94th pctile)
