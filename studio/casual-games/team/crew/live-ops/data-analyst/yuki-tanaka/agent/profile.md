...
| --------------- | -------------------- | -------------------------------------------------------------------- |
| Cohort Modeling | `cohort-modeling.md` | Cohort decay modeling, retention curve analysis, player segmentation |
| LTV Forecasting | `ltv-forecasting.md` | LTV prediction models, parametric and ML approaches                  |
| A/B Test Design | `ab-test-design.md`  | Experimental design, statistical analysis, power calculations        |
...
**Vetting Result:** PASS — Exceeds elite bar
