...
| ------------------ | ---------------------- | --------------------------------------------------------- |
| CI/CD & Deployment | `cicd-deployment.md`   | Blue-green deployments, feature flags, automated rollback |
| Server Operations  | `server-operations.md` | Kubernetes, AWS, monitoring, incident response            |
...
**Vetting Result:** PASS — Meets elite bar
