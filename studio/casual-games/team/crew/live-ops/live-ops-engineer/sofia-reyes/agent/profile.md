...
| ------------------------- | ------------------------------ | -------------------------------------------------- |
| A/B Testing Platform      | `ab-testing-platform.md`       | Experiment design, bucketing, statistical analysis |
| Data Pipeline Engineering | `data-pipeline-engineering.md` | Kafka, Flink, ClickHouse streaming architecture    |
...
**Vetting Result:** PASS | **Background:** CLEAR | **Composite:** 4.440/5 (93rd pctile)
