...
| -------------------- | ------------------------------- | ----------------------------------------------------------------------- |
| Paid UA Management   | `paid-ua-management.md`         | Meta Ads, Google UAC, ASA campaign management and optimization          |
| Creative Testing     | `creative-testing-framework.md` | Systematic creative testing, kill/scale decisions, performance tracking |
| ASO & Organic Growth | `aso-organic-growth.md`         | App Store Optimization, organic user acquisition                        |
...
**Vetting Result:** PASS — Meets elite bar (≥ 4 on 4 of 5 dimensions)
