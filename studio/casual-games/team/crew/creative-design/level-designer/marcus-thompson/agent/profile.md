...
# Marcus Thompson — Level Designer
...
| Skill                 | Location                     |
| --------------------- | ---------------------------- |
| `level-design.md`     | `skills/level-design.md`     |
| `encounter-design.md` | `skills/encounter-design.md` |
| `playtesting.md`      | `skills/playtesting.md`      |
