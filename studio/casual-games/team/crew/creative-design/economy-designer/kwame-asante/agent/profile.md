...
| --------------------- | -------------------------- | ------------------------------------------------------ |
| Economy Design        | `economy-design.md`        | F2P economy design, currency balancing, pricing models |
| Monetization Strategy | `monetization-strategy.md` | IAP design, battle passes, limited-time offers         |
...
**Vetting Result:** PASS | **Background:** CLEAR | **Composite:** 4.500/5 (95th pctile)
