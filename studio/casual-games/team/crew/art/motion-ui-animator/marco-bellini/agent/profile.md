...
# Marco Bellini — Motion/UI Animator
...
| Skill                  | Location                      |
| ---------------------- | ----------------------------- |
| `ui-animation.md`      | `skills/ui-animation.md`      |
| `character-rigging.md` | `skills/character-rigging.md` |
| `animation-specs.md`   | `skills/animation-specs.md`   |

## Vetting Record

| Assessment        | Result                    |
| ----------------- | ------------------------- |
| Composite Score   | 4.380/5 (92nd percentile) |
| Vetting Score     | 17/20                     |
| Impact at Scale   | 4/5                       |
| Craft Depth       | 5/5                       |
