...
| Skill                       | Location                           |
| --------------------------- | ---------------------------------- |
| `game-ui-art.md`            | `skills/game-ui-art.md`            |
| `icon-design-system.md`     | `skills/icon-design-system.md`     |
| `mobile-ui-optimization.md` | `skills/mobile-ui-optimization.md` |

## Vetting Record

| Assessment        | Result                    |
| ----------------- | ------------------------- |
| Composite Score   | 4.420/5 (93rd percentile) |
| Vetting Score     | 17/20                     |
| Impact at Scale   | 4/5                       |
| Craft Depth       | 5/5                       |
