...
| Skill                | Location                    |
| -------------------- | --------------------------- |
| `environment-art.md` | `skills/environment-art.md` |
| `prop-modeling.md`   | `skills/prop-modeling.md`   |
| `lod-creation.md`    | `skills/lod-creation.md`    |

## Vetting Record

| Assessment        | Result                    |
| ----------------- | ------------------------- |
| Composite Score   | 4.340/5 (91st percentile) |
| Vetting Score     | 16/20                     |
| Impact at Scale   | 4/5                       |
| Craft Depth       | 5/5                       |
