...
| Skill                       | Location                           |
| --------------------------- | ---------------------------------- |
| `character-modeling.md`     | `skills/character-modeling.md`     |
| `pbr-texturing.md`          | `skills/pbr-texturing.md`          |
| `mobile-3d-optimization.md` | `skills/mobile-3d-optimization.md` |

## Vetting Record

| Assessment        | Result                    |
| ----------------- | ------------------------- |
| Composite Score   | 4.400/5 (93rd percentile) |
| Vetting Score     | 17/20                     |
| Impact at Scale   | 4/5                       |
| Craft Depth       | 5/5                       |
