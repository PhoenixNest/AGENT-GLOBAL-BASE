...
| Skill                        | Location                            |
| ---------------------------- | ----------------------------------- |
| `particle-systems.md`        | `skills/particle-systems.md`        |
| `shader-vfx.md`              | `skills/shader-vfx.md`              |
| `mobile-vfx-optimization.md` | `skills/mobile-vfx-optimization.md` |

## Vetting Record

| Assessment        | Result                    |
| ----------------- | ------------------------- |
| Composite Score   | 4.440/5 (94th percentile) |
| Vetting Score     | 17/20                     |
| Impact at Scale   | 4/5                       |
| Craft Depth       | 5/5                       |
