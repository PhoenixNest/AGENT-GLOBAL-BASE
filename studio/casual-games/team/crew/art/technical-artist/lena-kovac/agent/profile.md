...
| Skill                              | Location                                  |
| ---------------------------------- | ----------------------------------------- |
| `shader-programming.md`            | `skills/shader-programming.md`            |
| `art-pipeline-optimization.md`     | `skills/art-pipeline-optimization.md`     |
| `dcc-tool-integration.md`          | `skills/dcc-tool-integration.md`          |
| `mobile-rendering-optimization.md` | `skills/mobile-rendering-optimization.md` |

## Vetting Record

| Assessment        | Result                    |
| ----------------- | ------------------------- |
| Composite Score   | 4.360/5 (92nd percentile) |
| Vetting Score     | 16/20                     |
| Impact at Scale   | 4/5                       |
| Craft Depth       | 5/5                       |
