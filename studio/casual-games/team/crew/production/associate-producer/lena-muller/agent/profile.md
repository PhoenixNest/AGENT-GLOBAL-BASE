...
| ------------------------- | ------------------------------ | ------------------------------------------------------------- |
| Agile Production          | `agile-production.md`          | Sprint planning, task tracking, meeting facilitation          |
| Stakeholder Communication | `stakeholder-communication.md` | Status reporting, risk communication, cross-team coordination |
...
**Vetting Result:** PASS | **Background:** CLEAR | **Composite:** 4.370/5 (90th pctile)
