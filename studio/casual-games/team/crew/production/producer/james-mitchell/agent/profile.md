...
| Skill                              | Location                                  |
| ---------------------------------- | ----------------------------------------- |
| `agile-production.md`              | `skills/agile-production.md`              |
| `risk-management.md`               | `skills/risk-management.md`               |
| `cross-functional-coordination.md` | `skills/cross-functional-coordination.md` |
| `jira-confluence.md`               | `skills/jira-confluence.md`               |

## Vetting Record

| Assessment        | Result                    |
| ----------------- | ------------------------- |
| Composite Score   | 4.285/5 (89th percentile) |
| Vetting Score     | 16/20                     |
| Impact at Scale   | 4/5                       |
| Craft Depth       | 4/5                       |
