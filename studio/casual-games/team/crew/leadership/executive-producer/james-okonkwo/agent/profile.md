...
- `skills/production-management.md` — Production planning, schedule management, resource allocation, Agile/Scrum execution, and cross-team dependency management across Stages 4–9
- `skills/launch-readiness.md` — Launch readiness checklist management, soft launch execution, global launch coordination, and post-launch transition planning for Stages 7, 8, and 9
