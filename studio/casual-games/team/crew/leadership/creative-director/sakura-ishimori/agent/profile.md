...
- `skills/creative-vision.md` — Creative vision definition, art direction oversight, visual pillar development, and GDD creative authorship across Stages 0–3
- `skills/monetization-design.md` — Player-centric F2P monetization strategy, IAP design, event pass systems, and engagement loop design that serves player motivation
