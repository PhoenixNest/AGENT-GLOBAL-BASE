...
| Gemini CLI CLI | Local installation                          | Hooks feature enabled, configured in `.gemini/settings.json` |
...
**Location:** `.gemini/hooks/company/automated-recruitment-pipeline/scripts/`

**Count:** 11 Python files, 0 shell scripts

**Test:** `python .gemini/hooks/company/automated-recruitment-pipeline/tests/run-all-tests.py`
