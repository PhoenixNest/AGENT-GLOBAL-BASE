...
| Scenario                        | Approach                                                                                                                                                                                        |
| ------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **zh-CN vs zh-TW**              | Same key namespace. Separate value files (`values-zh-rCN/strings.xml`, `zh_CN.lproj/Localizable.strings`).                                                                                      |
...
2. **Developer adds the key** to both `strings.xml` (Android) and `Localizable.strings` (iOS) with the English value.
