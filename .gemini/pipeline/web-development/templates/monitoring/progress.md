...
Overall: [XX]%
├── Web Frontend (Track W-FE) — [FULL/LIGHT] — [XX]%
├── Web Backend (Track W-BE) — [FULL/LIGHT] — [XX]%
├── Full-Stack Integration (Track W-FS) — [PRIMARY/LIGHT] — [XX]%
...
| ------------------------------ | ------------- | -------------------------------- | -------------- | -------------- | ---------- | ------ | ----------- |
| [e.g., Next.js SSR regression] | ADR-NNN       | [Active / Monitoring / Resolved] | [Low/Med/High] | [Low/Med/High] | [Plan]     | [Name] | YYYY-MM-DD  |
...
| Metric                       | Web Frontend       | Web Backend        | Integration        |
| ---------------------------- | ------------------ | ------------------ | ------------------ |
