...
description: Design, implement, and maintain secure Infrastructure as Code (IaC) using Terraform, implementing module architecture best practices, state management security, drift detection.
---
