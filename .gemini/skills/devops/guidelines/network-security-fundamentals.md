...
description: Network security fundamentals for cloud infrastructure, covering VPC design, security group configuration, Network ACL management, and traffic inspection.
---
