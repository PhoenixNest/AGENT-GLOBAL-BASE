...
description: Authors, reviews, and maintains Architecture Decision Records (ADRs) and the Technology Selection Document (TSD) for the engineering organization.
---
