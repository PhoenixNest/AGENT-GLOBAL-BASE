---
name: adr-governance
description: Manages the Architecture Decision Record (ADR) lifecycle across the organization, establishing ADR template standards, designing architecture review processes.
---
