...
description: This skill covers mobile cross-platform architecture patterns, shared-core strategies, API design for mobile clients, offline-first synchronization, and architecture-to-implementation traceability.
---
