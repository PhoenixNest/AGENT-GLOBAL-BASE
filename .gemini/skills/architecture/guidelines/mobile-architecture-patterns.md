...
description: Design implementable, maintainable mobile application architectures for iOS, Android, and cross-platform (KMP/Flutter) projects. Produce logical project structures.
---
