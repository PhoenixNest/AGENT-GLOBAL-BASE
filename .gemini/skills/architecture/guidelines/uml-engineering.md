---
name: uml-engineering
description: Produces comprehensive UML engineering artifacts for system design, including class diagrams with relationships and design patterns.
---
