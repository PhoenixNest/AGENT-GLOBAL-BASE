---
name: react-native-prototyping
description: Rapidly prototypes mobile applications using React Native, implementing component architecture with functional components and hooks.
---
