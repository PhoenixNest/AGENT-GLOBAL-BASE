---
name: react-testing
description: Comprehensive React testing discipline covering component unit testing, integration testing, custom hook validation, and end-to-end user flow verification.
---
