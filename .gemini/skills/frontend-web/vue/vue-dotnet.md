---
name: vue-dotnet
description: Builds full-stack applications using Vue 3 Composition API frontend with .NET 7+ Minimal APIs backend, covering reactive state management with ref/computed/watch.
---
