...
description: Operates AWS cloud infrastructure for backend services, covering EC2 instance selection, ECS task definitions for container orchestration, RDS database configuration.
---
