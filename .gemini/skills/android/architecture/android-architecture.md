...
description: This skill defines production-grade Android application architecture patterns including MVVM, Clean Architecture, MVI, and state management with StateFlow.
---
