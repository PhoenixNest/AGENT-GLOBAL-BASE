...
description: This skill implements production-grade Flutter application architecture covering widget tree optimization, BLoC state management, Riverpod for dependency injection.
---
