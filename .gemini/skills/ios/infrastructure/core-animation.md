---
name: core-animation
description: This skill implements production-grade iOS animations using Core Animation covering CALayer manipulation, animation timing, the rendering pipeline, and performance optimization.
---
