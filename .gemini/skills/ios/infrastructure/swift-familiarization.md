...
description: Swift language fundamentals, concurrency patterns, and iOS platform awareness for engineers transitioning from other languages or cross-platform frameworks.
---
