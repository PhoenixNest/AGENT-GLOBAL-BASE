...
description: Platform-specific native mobile testing patterns covering Espresso and XCUITest advanced testing, native debugging, crash analysis, memory leak detection, ANR investigation, and performance profiling on Android and iOS.
---
...
| Skill            | Location                         |
| ---------------- | -------------------------------- |
| `android`        | `.gemini/skills/android/`        |
| `ios`            | `.gemini/skills/ios/`            |
| `cross-platform` | `.gemini/skills/cross-platform/` |
| `testing-qa`     | `.gemini/skills/testing-qa/`     |
| `security`       | `.gemini/skills/security/`       |

### 10.3 Pipeline References

| Document                        | Path                                                |
| ------------------------------- | --------------------------------------------------- |
| Pipeline Definition             | `.gemini/pipeline/mobile-development/pipeline.md`   |
