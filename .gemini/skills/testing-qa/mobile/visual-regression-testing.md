...
| --------------------- | ----------------------------------------------------------- | ------------------------------ |
| Stage 7 Specification | `.gemini/pipeline/mobile-development/pipeline.md`           | Test execution requirements    |
| Stage 8 Specification | `.gemini/pipeline/mobile-development/pipeline.md`           | Integrity verification process |
| Defect Classification | `GEMINI.md`                                                 | P0-P3 severity system          |
