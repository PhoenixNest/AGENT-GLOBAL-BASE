---
name: k6-performance
description: This skill covers k6 load testing for performance engineering — scenario configuration, threshold definition, distributed execution, result analysis, bottleneck identification.
---
