...
description: axe-core WCAG 2.1 AA automated accessibility testing covering integration with test frameworks, rule configuration, CI/CD gate enforcement, violation remediation, and coverage limitations for mobile and web platforms.
---
