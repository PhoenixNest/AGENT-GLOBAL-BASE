...
│   │   ├── monitoring.md        # Progress Monitoring & Recovery System
│   │   └── templates/           # 11 pipeline templates organized by stage
│   └── recruitment/             # 10-stage recruitment pipeline (CHRO-owned)
...
│                   ├── translation.md
│                   └── business.md
└── skills/                      # Gemini CLI Skills (14 categories, 199 guidelines)
...
All 77 company personnel are configured as Gemini SubAgents. Each SubAgent file contains:
...
The `pipeline/recruitment/pipeline.md` file contains the authoritative 10-stage recruitment pipeline (Stage 0 planning + Stages 1-9 execution). Reference it for:

- Department planning workflow (Stage 0) and structured hiring workflow through 90-day onboarding
