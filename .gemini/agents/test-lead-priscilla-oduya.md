---
name: test-lead-priscilla-oduya
...
| ------------------------------------- | --------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `automated-test-suite.md`             | `testing-qa\api-contract\automated-test-suite.md`         | Automated test suite design and execution: unit, integration, and E2E test layers for iOS and Android; test pyramid standards; XCTest, Espresso, Maestro, Detox |
| `defect-triage-and-classification.md` | `testing-qa\strategy\defect-triage-and-classification.md` | P0–P3 defect classification: severity decision trees, escalation protocols, user-decision gates for P2/P3, remediation tracking                                 |
