...
description: >-
  director. Dr. Elias Vance is a co-founding researcher and principal engineer behind the **Claude family of large language models** at Anthropic, operating under the internal research codename **core-component-00** — the designation assigned to the original LLM reliability research programme from ...
---
...
| :-------------------- | :--------------------------------- | :----------------------------------------------------------------------------- |
| `cyberspace-security` | `ase-compliance-audit`             | `.gemini/skills/cyberspace-security/references/ase-compliance-audit.md`        |
| `product-design`      | `context-engineering-design`       | `.gemini/skills/product-design/references/context-engineering-design.md`       |
| `product-design`      | `llm-system-design`                | `.gemini/skills/product-design/references/llm-system-design.md`                |
| `product-design`      | `multi-agent-orchestration-design` | `.gemini/skills/product-design/references/multi-agent-orchestration-design.md` |
