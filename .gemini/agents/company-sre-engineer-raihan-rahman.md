---
name: >-
  company-sre-engineer-raihan-rahman
description: >-
  teammate in Research & Development. Raihan Rahman holds an M.S. in Computer Systems from Georgia Institute of Technology and has 8 years of SRE/infrastructure experience.
---
...
| :-------------------------- | :--------------------- | :---------------------------------------------------------------------------- |
| `visual-arts-and-animation` | `cloud-infrastructure` | `.gemini/skills/visual-arts-and-animation/references/cloud-infrastructure.md` |
| `backend-engineering`       | `gcp-multi-region`     | `.gemini/skills/backend-engineering/references/gcp-multi-region.md`           |
| `visual-arts-and-animation` | `sre-practices`        | `.gemini/skills/visual-arts-and-animation/references/sre-practices.md`        |
