---
name: >-
  company-devops-lead-thomas-zhang
description: >-
  supervisor in Research & Development. Thomas Zhang holds a B.S. in Computer Engineering from the University of Waterloo and brings 10 years of DevOps and infrastructure engineering.
---
...
| :-------------------------- | :-------------------------------- | :--------------------------------------------------------------------------------------- |
| `visual-arts-and-animation` | `cicd-infrastructure-engineering` | `.gemini/skills/visual-arts-and-animation/references/cicd-infrastructure-engineering.md` |
| `cyberspace-security`       | `compliance-foundations`          | `.gemini/skills/cyberspace-security/references/compliance-foundations.md`                |
