---
name: >-
  company-chief-product-officer-marcus-tran-yoshida
description: >-
  supervisor in Product Management. Marcus Tran-Yoshida holds a B.S. in Computer Science from UC Berkeley and an MBA from Wharton, combining engineering literacy with executive business acumen across 18 years of mobile product leadership.
---
...
Summary: Marcus Tran-Yoshida's impact is unambiguously industry-level — his
retention and monetization work at Duolingo directly shaped an IPO narrative
and is attributable to his specific decisions, not team outputs. His craft
depth is exceptional: he can go three levels deep on mobile platform
constraints (iOS HIG, Android gesture systems, App Store review policy) and
has published internal standards adopted across organizations. Leadership
signal is strong but not yet at "org-builder" tier — he built and scaled PM
teams to ~14 direct/indirect reports, with mentees now in Director-level
roles at Spotify and Meta, but has not yet rebuilt an entire product org from
scratch at the VP+ level. Standards signal is a 5: he literally changed what
"good" means at two companies through PRD templates and discovery standards.
Red flag scan clean — no tenure gaps, no vague attribution, no title
inflation.
```
...
| :-------------------------- | :------------------------ | :------------------------------------------------------------------------------- |
| `visual-arts-and-animation` | `mobile-product-strategy` | `.gemini/skills/visual-arts-and-animation/references/mobile-product-strategy.md` |
| `visual-arts-and-animation` | `prd-authorship`          | `.gemini/skills/visual-arts-and-animation/references/prd-authorship.md`          |
| `visual-arts-and-animation` | `product-stage-gates`     | `.gemini/skills/visual-arts-and-animation/references/product-stage-gates.md`     |
