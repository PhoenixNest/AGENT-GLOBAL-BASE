---
name: >-
  company-backend-engineer-omar-hassan
description: >-
  teammate in Research & Development. Omar Hassan holds a B.S. in Computer Science from Cairo University and has 4 years of backend engineering experience.
---
...
| :-------------------- | :------------------ | :------------------------------------------------------------------ |
| `backend-engineering` | `go-microservices`  | `.gemini/skills/backend-engineering/references/go-microservices.md` |
| `backend-engineering` | `go-rest-api`       | `.gemini/skills/backend-engineering/references/go-rest-api.md`      |
| `backend-engineering` | `go-testing`        | `.gemini/skills/backend-engineering/references/go-testing.md`       |
