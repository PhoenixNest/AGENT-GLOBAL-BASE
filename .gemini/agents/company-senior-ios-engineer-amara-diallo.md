---
name: >-
  company-senior-ios-engineer-amara-diallo
description: >-
  teammate in Research & Development. Amara Diallo holds an M.S. in Software Engineering from EPFL (Switzerland) and has 7 years of iOS engineering experience.
---
...
| :---------------- | :----------------------------- | :-------------------------------------------------------------------------- |
| `ios-engineering` | `combine-reactive-programming` | `.gemini/skills/ios-engineering/references/combine-reactive-programming.md` |
| `ios-engineering` | `ios-ci-cd`                    | `.gemini/skills/ios-engineering/references/ios-ci-cd.md`                    |
| `ios-engineering` | `ios-networking`               | `.gemini/skills/ios-engineering/references/ios-networking.md`               |
