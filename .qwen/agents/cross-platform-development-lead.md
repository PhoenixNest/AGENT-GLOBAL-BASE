...
- `kmp-implementation.md` — Kotlin Multiplatform implementation: shared module architecture, expect/actual patterns, Ktor networking, SQLDelight database, Swift interoperability
- `flutter-implementation.md` — Flutter application development: Dart, widget architecture, platform channels, Riverpod state management, custom design systems, App Store and Google Play submission
