...
- `mobile-product-strategy.md` — End-to-end mobile product strategy: vision setting, roadmap prioritization, commercial/quality balance, and platform-native decision-making for iOS and Android
- `prd-authorship.md` — High-quality PRD authorship: problem framing, platform constraints, metric instrumentation, technical feasibility pre-assessment, and launch sequencing
