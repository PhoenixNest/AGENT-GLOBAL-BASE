...
- `mobile-ui-translation.md` — Mobile UI string translation: Japanese localization, keigo calibration, character count optimization, MT post-editing, platform formatting validation
