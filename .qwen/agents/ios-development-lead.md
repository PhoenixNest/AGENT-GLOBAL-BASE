...
- `ios-implementation.md` — iOS application development: SwiftUI, Swift Concurrency, MVVM architecture, Keychain security, CoreData, URLSession, App Store Connect submission
