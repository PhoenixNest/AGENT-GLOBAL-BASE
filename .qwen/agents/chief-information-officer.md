...
- `technology-evaluation.md` — Systematic evaluation of emerging technologies: research methodology, competitive analysis, risk assessment, and executive-grade documentation
- `mobile-architecture-strategy.md` — Mobile-native infrastructure and architecture strategy for iOS and Android platforms
- `technical-selection-documentation.md` — High-quality technical selection documents, version analysis reports, and architecture decision records
