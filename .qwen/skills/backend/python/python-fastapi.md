---
name: python-fastapi
description: Builds production-grade REST APIs using Python FastAPI framework, leveraging its dependency injection system, Pydantic v2 data models, async endpoint patterns.
---
