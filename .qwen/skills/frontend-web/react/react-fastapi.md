---
name: react-fastapi
description: Integrates React frontends with Python FastAPI backends, leveraging React Query for async state management, async task queues with Celery and Redis.
---
