...
description: Translate mobile UI strings from the EN-source handoff package into the assigned target language, produce correctly structured platform resource files.
---
