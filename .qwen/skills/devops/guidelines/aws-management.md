---
name: aws-management
description: AWS cloud platform management for a multi-account organization, covering AWS Organizations setup, Control Tower governance, SCPs, cross-account IAM role design, and centralized CloudTrail logging.
---
