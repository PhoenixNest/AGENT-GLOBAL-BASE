...
description: This skill implements the Android data layer covering the Repository pattern, Room database operations, Retrofit API clients, serialization strategies, and data synchronization mechanisms.
---
