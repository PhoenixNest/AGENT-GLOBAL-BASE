---
name: device-farm-management
description: This skill covers the operation, optimization, and management of cloud-based device farms for mobile test execution. It encompasses AWS Device Farm, Firebase Test Lab.
---
