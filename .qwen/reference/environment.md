...
| Qwen Code CLI | Local installation                          | Hooks feature enabled, configured in `.qwen/settings.json` |
...
**Location:** `.qwen/hooks/company/automated-recruitment-pipeline/scripts/`
