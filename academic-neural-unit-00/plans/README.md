...
| `2026-08-19-curriculum-coding-and-post-training-extension/` | 2026-08-19 | 8 new modules (coding practicum + post-training track) addressing the Pass 3 review's scope decision S-2 — **approved by CEO; executed 2026-08-27–28: all 8 modules authored, internally reviewed (Phase 3) and remediated, externally blind-reviewed (Phase 4, technical-accuracy + interview-readiness) and remediated, and corpus-wide citation-format polished — closed** |
...
| `2026-08-31-curriculum-books-restructure/`                  | 2026-08-31 | Grouped the curriculum's four content folders under a new `books/` subfolder with reading-order numbering (`01-introductory`–`04-advanced`, practicum placed third), plus the citation-URL corrections it required — **approved by CEO 2026-08-31; executed and closed the same day**                                                                                         |
