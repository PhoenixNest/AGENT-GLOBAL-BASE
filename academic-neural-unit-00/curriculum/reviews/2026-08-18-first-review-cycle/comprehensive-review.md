...
- I confirmed the internal-workspace citation he checked in `advanced/07`: §4 does cite `core-component-00/engineering/multi-agent-engineering/fundamentals/git-worktree-orchestration.md` and does narrate the directory-junction incident, and his conclusion that the module represents that source accurately holds.
