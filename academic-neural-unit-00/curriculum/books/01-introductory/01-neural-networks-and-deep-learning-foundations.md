...
Every module after this one — the Transformer architecture in [`introductory/02` — The Transformer Architecture & Attention](https://anu00.dev/curriculum/books/01-introductory/02-the-transformer-architecture-and-attention.md), attention mechanics
in [`intermediate/02` — Attention Deep Dive: Multi-Head Attention, KV-Cache & Positional Encoding](https://anu00.dev/curriculum/books/02-intermediate/02-attention-deep-dive-multi-head-kv-cache-positional-encoding.md), and mixture-of-experts variants in [`advanced/02` — Mixture-of-Experts & Modern Architecture Variants](https://anu00.dev/curriculum/books/04-advanced/02-mixture-of-experts-and-modern-architecture-variants.md) — is a refinement or
...
本模块之后的每一个模块——[`introductory/02` — The Transformer Architecture & Attention](https://anu00.dev/curriculum/books/01-introductory/02-the-transformer-architecture-and-attention.md) 中的 Transformer 架构、[`intermediate/02` — Attention Deep Dive: Multi-Head Attention, KV-Cache & Positional Encoding](https://anu00.dev/curriculum/books/02-intermediate/02-attention-deep-dive-multi-head-kv-cache-positional-encoding.md) 中的注意力机制细节，以及 [`advanced/02` — Mixture-of-Experts & Modern Architecture Variants](https://anu00.dev/curriculum/books/04-advanced/02-mixture-of-experts-and-modern-architecture-variants.md) 中的专家混合变体——都是对本章所引入这一核心思想的细化或扩展：数字流经一层层简单的运算，而学习过程会调整这些运算的内部数值，使输出逐渐逼近期望的结果。透彻理解本章，是整个课程体系中回报率最高的一项投入。
...
- [`introductory/02` — The Transformer Architecture & Attention](https://anu00.dev/curriculum/books/01-introductory/02-the-transformer-architecture-and-attention.md) — builds directly on the neuron/layer/training vocabulary defined here.
- [`intermediate/02` — Attention Deep Dive: Multi-Head Attention, KV-Cache & Positional Encoding](https://anu00.dev/curriculum/books/02-intermediate/02-attention-deep-dive-multi-head-kv-cache-positional-encoding.md) — extends the attention mechanism introduced in [`introductory/02` — The Transformer Architecture & Attention](https://anu00.dev/curriculum/books/01-introductory/02-the-transformer-architecture-and-attention.md).
- [`advanced/02` — Mixture-of-Experts & Modern Architecture Variants](https://anu00.dev/curriculum/books/04-advanced/02-mixture-of-experts-and-modern-architecture-variants.md) — extends the layer/network vocabulary from this chapter into sparse architectures.
