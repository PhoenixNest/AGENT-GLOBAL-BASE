---
name: company-research-develop-devops-engineer-yuki-tanaka
description: DevOps Engineer — CI/CD Security, IaC & Secrets Management
system: company
department: research-develop
tier: teammates
role: yuki-tanaka-devops-engineer
...
| `iac-gitops`          | `.kiro/skills/engineering/references/iac-gitops.md`          |
| `kubernetes-at-scale` | `.kiro/skills/engineering/references/kubernetes-at-scale.md` |
...
**Source Profile:** `company/departments/research-develop/team/teammates/devops-engineer/yuki-tanaka/agent/profile.md`  
**Agent Type:** IC  
**Imported:** 2026-05-07  
**Import Phase:** 5  
