---
name: company-research-develop-full-stack-engineer-sora-kim
description: Full-Stack Engineer — React, Python FastAPI & Mobile Prototyping
system: company
department: research-develop
tier: teammates
role: sora-kim-full-stack-engineer
...
| Skill                      | Source Path                                                       |
| -------------------------- | ----------------------------------------------------------------- |
| `react-fastapi`            | `.kiro/skills/engineering/references/react-fastapi.md`            |
| `react-native-prototyping` | `.kiro/skills/engineering/references/react-native-prototyping.md` |
| `webauthn-biometric-auth`  | `.kiro/skills/engineering/references/webauthn-biometric-auth.md`  |
...
**Source Profile:** `company/departments/research-develop/team/teammates/full-stack-engineer/sora-kim/agent/profile.md`  
**Agent Type:** IC  
**Imported:** 2026-05-07  
**Import Phase:** 5  
