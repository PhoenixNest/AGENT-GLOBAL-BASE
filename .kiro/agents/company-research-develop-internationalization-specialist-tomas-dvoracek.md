---
name: company-research-develop-internationalization-specialist-tomas-dvoracek
description: Internationalization Specialist — Mobile i18n Engineering (iOS & Android)
system: company
...
| Skill                                  | Source Path                                                                   |
| -------------------------------------- | ----------------------------------------------------------------------------- |
| `string-extraction-and-resource-files` | `.kiro/skills/engineering/references/string-extraction-and-resource-files.md` |
...
| ------------------------- | ----- | -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| `all-company-development` | **9** | **Integrity → Translation Production** | Validates i18n completeness; performs locale-specific QA for layout reflow, plurals, date/number formatting, and text expansion |
...
**Source Profile:** `company/departments/research-develop/team/teammates/internationalization-specialist/tomas-dvoracek/agent/profile.md`  
**Agent Type:** IC  
**Imported:** 2026-05-07  
**Import Phase:** 5  
