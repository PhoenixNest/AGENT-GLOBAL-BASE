---
name: company-cyberspace-security-security-engineer-omar-farouq
description:
  "Security Engineer #2 — Web Application Security & SAST/DAST Pipeline
  Engineering"
system: company
department: cyberspace-security
tier: teammates
role: omar-farouq-security-engineer
...
| Skill                        | Source Path                                                                 |
| ---------------------------- | --------------------------------------------------------------------------- |
| `sast-dast-pipeline`         | `.kiro/skills/cyberspace-security/references/sast-dast-pipeline.md`         |
| `web-application-security`   | `.kiro/skills/cyberspace-security/references/web-application-security.md`   |
| `masvs-certification`        | `.kiro/skills/cyberspace-security/references/masvs-certification.md`        |
...
**Source Profile:** `company/departments/cyberspace-security/team/teammates/security-engineer/omar-farouq/agent/profile.md`  
**Agent Type:** IC  
**Imported:** 2026-05-07  
**Import Phase:** 5  
