---
name: company-product-management-mobile-product-strategy
description: End-to-end mobile product strategy for iOS and Android. Use this skill whenever Marcus is asked to set product direction, define a roadmap, prioritize features, evaluate commercial vs. quality trade-offs, assess platform constraints, plan a mobile launch, or advise on Android/iOS ecosystem strategy.
version: "1.0.0"
source: company/departments/product-management/supervisor/chief-product-officer/skills/mobile-product-strategy.md
agents:
