...
description: Designs and manages PostgreSQL database architectures at scale, implementing table partitioning strategies, read replica topologies, connection pooling with PgBouncer.
---
