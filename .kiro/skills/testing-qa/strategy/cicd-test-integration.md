...
| ---------------------- | ------------------------------ | ------------------------------------ |
| Testing QA Overview    | `.qwen/skills/testing-qa/`     | Parent skill category                |
| Android Testing        | `.qwen/skills/android/`        | Platform-specific test configuration |
| iOS Testing            | `.qwen/skills/ios/`            | Platform-specific test configuration |
| Cross-Platform Testing | `.qwen/skills/cross-platform/` | KMP/Flutter test strategies          |
| Frontend Web Testing   | `.qwen/skills/frontend-web/`   | Web E2E and component tests          |
| Backend Testing        | `.qwen/skills/backend/`        | API and integration tests            |
| Security               | `.qwen/skills/security/`       | SAST/DAST integration                |
| DevOps                 | `.qwen/skills/devops/`         | Pipeline infrastructure and CI/CD    |
| Shared                 | `.qwen/skills/shared/`         | Cross-cutting TDD practices          |
