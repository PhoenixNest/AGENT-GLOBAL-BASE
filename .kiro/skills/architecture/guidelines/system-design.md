---
name: system-design
description: This skill covers system design fundamentals, trade-off analysis, and architecture pattern selection for distributed systems with explicit application to mobile product backends.
---
