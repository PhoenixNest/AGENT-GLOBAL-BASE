---
name: company-cyberspace-security-technology-evaluation
...
version: "1.0.0"
source: company/departments/cyberspace-security/supervisor/chief-information-officer/skills/technology-evaluation.md
agents:
...
**Scenario 1**: Product asks "Should we use React Native or native iOS/Android?"

- Evaluate both against framework
- Focus on mobile platform fit and long-term maintenance cost
- Provide clear recommendation with migration risk assessment

**Scenario 2**: Engineering proposes adopting GraphQL for mobile APIs

- Assess technical merit (query flexibility, payload size)
- Evaluate mobile-specific benefits (reduced over-fetching, offline support)
- Analyze implementation risk (backend changes, client SDK complexity)
- Recommend adoption path or alternative

**Scenario 3**: Vendor pitches a mobile analytics platform

- Compare against existing solution and alternatives
- Assess cost structure and lock-in risk
- Evaluate data privacy implications for iOS/Android app store compliance
- Recommend trial, adoption, or pass

## Collaboration Points

- **With CPO**: Validate business impact assumptions, competitive positioning
- **With CTO** (when hired): Validate technical merit, implementation risk, team capability
- **With Engineering**: Validate integration complexity, developer experience claims
- **With Product**: Validate time-to-value estimates, feature requirements
