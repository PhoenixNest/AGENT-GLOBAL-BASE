---
name: iac-gitops
description: Infrastructure as Code using GitOps workflows, covering Terraform, Terragrunt, Atlantis, automated plan/apply pipelines, state management with locking, and pull request-based infrastructure change governance.
---
