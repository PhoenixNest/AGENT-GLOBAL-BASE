...
└── monitoring/
    ...
    ├── stage-transition-schemas.md                    ← JSON Schema Contracts — API Adapted (ASGF Phase 2)
    ├── inter-agent-communication-protocol.md          ← IACP — Backend Routing (ASGF Phase 2)
    ...
    └── schema-validation-spec.md                      ← Automated Gate Enforcement — V-API- Rules (ASGF Phase 3)
```
...
| 2 — Design              | `IDS.md` (OpenAPI/GraphQL SDL/Protobuf)                                                                                                                                                                                                                                                               | 1     |
...
| 7 — Testing             | `TEST-RESULTS-REPORT.md`, `LOAD-PROFILE-MATRIX.md`                                                                                                                                                                                                                                                    | 2     |
...
| `stage-transition-schemas.md`           | ASGF — L2   | Phase 2    |   🔧 API-adapted   |
| `inter-agent-communication-protocol.md` | ASGF — L2/3 | Phase 2    |   🔧 API-adapted   |
...
| `schema-validation-spec.md`             | ASGF — L3   | Phase 3    | 🔧 V-API- prefixed |
