...
**Full specification:** see the per-product `monitoring.md` (e.g., [`../mobile-development/monitoring.md`](../mobile-development/monitoring.md)) — Progress Monitoring & Recovery System (mandatory for Stage 4+ projects).
