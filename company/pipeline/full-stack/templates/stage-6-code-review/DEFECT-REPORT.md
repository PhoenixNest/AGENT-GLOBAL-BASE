...
**Version:** v1
**Date:** YYYY-MM-DD
**Reviewed By:** CTO Panel (CPO, CDO, CTO, CIO, CSO) + VP Web (Julia Thorne), VP API (Alex Rivera) + Platform Leads (Tier 1)
...
### Frontend Lead → Web Code Review

| Aspect                       | Assessment                           | Details                 |
| ---------------------------- | ------------------------------------ | ----------------------- |
| **Code quality**             | [Excellent / Good / Needs Work]      | [Specific observations] |
| **Architecture conformance** | [Matches UML/ADR / Deviations noted] | [List deviations]       |
| **Security observations**    | [Findings: XSS, CSP, CSRF]           | [File-level references] |
| **Test quality**             | [Adequate / Gaps noted]              | [Missing Vitest/RTL]    |
| **Performance**              | [Lighthouse scores]                  | [LCP, CLS, TTI values]  |
| **Accessibility**            | [axe-core results]                   | [Violations found]      |
| **Key findings**             | [Top 3 concerns]                     | [Details]               |
...
| ----------- | ---------- | -------- | ------------ | ------------- | ------------------ |
| IDS §7      | No network | Web      | ☐ Yes / ☐ No | ☐ Yes / ☐ No  | [P#-XXX or None]   |
...
| ----------- | -------------------- | -------- | ------------ | ------------------ | ------------------ |
| IDS §10.1   | Screen reader labels | Web      | ☐ Yes / ☐ No | ☐ Yes / ☐ No       | [P#-XXX or None]   |
...
| IDS §10.2   | Touch targets        | Web      | ☐ Yes / ☐ No | ☐ Yes / ☐ No       | [P#-XXX or None]   |
| IDS §10.2   | Touch targets        | Android  | ☐ Yes / ☐ No | ☐ Yes / ☐ No       | [P#-XXX or None]   |
| IDS §10.2   | Touch targets        | iOS      | ☐ Yes / ☐ No | ☐ Yes / ☐ No       | [P#-XXX or None]   |
| IDS §10.3   | Contrast ratios      | All      | ☐ Yes / ☐ No | ☐ Yes / ☐ No       | [P#-XXX or None]   |
| IDS §10.4   | Focus order          | All      | ☐ Yes / ☐ No | ☐ Yes / ☐ No       | [P#-XXX or None]   |
| IDS §10.5   | Dynamic type (200%)  | Web      | ☐ Yes / ☐ No | ☐ Yes / ☐ No       | [P#-XXX or None]   |
| IDS §10.5   | Dynamic type (200%)  | iOS      | ☐ Yes / ☐ No | ☐ Yes / ☐ No       | [P#-XXX or None]   |
| IDS §10.5   | Dynamic type (200%)  | Android  | ☐ Yes / ☐ No | ☐ Yes / ☐ No       | [P#-XXX or None]   |
| IDS §10.6   | Reduced motion       | All      | ☐ Yes / ☐ No | ☐ Yes / ☐ No       | [P#-XXX or None]   |
| IDS §10.7   | Keyboard navigation  | Web      | ☐ Yes / ☐ No | ☐ Yes / ☐ No       | [P#-XXX or None]   |
...
| IDS Section | Token            | Expected (Web)       | Expected (Android)   | Expected (iOS)     | Applied Correctly? | Defect ID (if any) |
| ----------- | ---------------- | -------------------- | -------------------- | ------------------ | ------------------ | ------------------ |
| IDS §9      | color.primary    | var(--color-primary) | @color/primary       | AssetColor.primary | ☐ Yes / ☐ No       | [P#-XXX or None]   |
| IDS §9      | spacing.md       | var(--spacing-md)    | 16dp                 | 16pt               | ☐ Yes / ☐ No       | [P#-XXX or None]   |
| IDS §9      | typography.body1 | var(--font-body)     | TextAppearance.Body1 | UIFont.body        | ☐ Yes / ☐ No       | [P#-XXX or None]   |
