...
- **Stage:** <N> (<Stage Name>)
- **Stage Progress:** <XX>%
- **Pipeline Type:** full-stack
- **Platform Combination:** <web + iOS + Android | web + Android | iOS + API | etc.>
...
Overall: [XX]%
├── Web Frontend (Track FS-WFE) — [FULL/LIGHT] — [XX]%
├── Web Backend (Track FS-WBE) — [FULL/LIGHT] — [XX]%
├── Mobile (Track FS-MOB) — [FULL/LIGHT] — [XX]%
├── Integration & QA (Track FS-INT) — [FULL/LIGHT] — [XX]%
├── Platform Parity Status: [XX]% feature coverage across platforms
...
| [Feature 2] | ✅ Yes | ✅ Yes | ☐ No    | Yes  |
| [Feature 3] | ✅ Yes | ☐ No   | ☐ No    | Yes  |
...
| ------------------------------- | ------------- | -------------------------------- | -------------- | -------------- | ---------- | ------ | ----------- |
| [e.g., Platform divergence]     | ADR-NNN       | [Active / Monitoring / Resolved] | [Low/Med/High] | [Low/Med/High] | [Plan]     | [Name] | YYYY-MM-DD  |
| [e.g., Auth flow inconsistency] | ADR-NNN       | [Active / Monitoring / Resolved] | [Low/Med/High] | [Low/Med/High] | [Plan]     | [Name] | YYYY-MM-DD  |

## Security Metrics (Stage 5+)

| Metric                       | Web Frontend       | Web Backend        | Mobile             | Integration        |
| ---------------------------- | ------------------ | ------------------ | ------------------ | ------------------ |
| SRD requirements implemented | X/Y                | X/Y                | X/Y                | X/Y                |
| SAST findings (open)         | P0:0, P1:0, P2:X   | P0:0, P1:0, P2:X   | P0:0, P1:0, P2:X   | P0:0, P1:0, P2:X   |
| Dependency vulnerabilities   | 0 critical, X high | 0 critical, X high | 0 critical, X high | 0 critical, X high |
| Security review coverage     | XX%                | XX%                | XX%                | XX%                |
