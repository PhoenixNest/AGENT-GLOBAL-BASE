...
- `skills/mobile-security-architecture.md` — Mobile platform security architecture: iOS/Android security models, encryption, secure storage, platform-specific protections
- `skills/application-security-hardening.md` — Application security hardening: code obfuscation, anti-tampering, RASP, threat mitigation strategies
- `skills/security-risk-assessment.md` — Security risk assessment and compliance: threat modeling, penetration testing, OWASP MASVS, PCI-DSS, security reviews
- `skills/emerging-threat-evaluation.md` — Emerging technology security evaluation: threat intelligence, security implications of new technologies, risk identification
...
Summary: Dr. Sarah Chen's impact is unambiguously industry-defining — her mobile security work at Meta protects 3.2B users and her contributions to OWASP Mobile Security Project have established industry standards that competitors benchmark against. Her craft depth is exceptional: she operates fluently across mobile platform security (iOS Secure Enclave, Android SafetyNet), application hardening (obfuscation, RASP, anti-tampering), emerging technology security evaluation, and compliance frameworks (PCI-DSS, OWASP MASVS). Leadership signal is elite — she built and scaled a 28-person security organization and her security architecture decisions influence product roadmaps at Meta. Standards signal is a 5: her mobile security review process became mandatory company-wide at Meta and her threat intelligence work shaped OWASP standards still used industry-wide. Red flag scan clean — continuous tenure progression, specific attributable outcomes ($47M fraud prevention, 89% incident reduction), no title inflation.
```
