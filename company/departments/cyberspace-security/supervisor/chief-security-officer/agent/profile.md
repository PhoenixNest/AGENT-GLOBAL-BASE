...
- `company/departments/cyberspace-security/supervisor/chief-security-officer/skills/mobile-security-architecture.md` — Mobile platform security architecture: iOS/Android security models, encryption, secure storage, platform-specific protections
