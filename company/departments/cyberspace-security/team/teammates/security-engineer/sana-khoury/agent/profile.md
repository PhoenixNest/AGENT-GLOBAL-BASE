...
- `skills/mobile-penetration-testing.md` — Mobile pen testing: SAST/DAST, runtime analysis, reverse engineering, OWASP MASVS
- `skills/owasp-masvs-compliance.md` — MASVS Level 1 and Level 2 compliance assessment, mobile security standards
