...
- `skills/supply-chain-security.md` — Supply chain security: SBOM, artifact signing, CI/CD hardening, marketplace action vetting
- `skills/secure-coding-training.md` — Secure coding curriculum design, Security Champions program, developer education
