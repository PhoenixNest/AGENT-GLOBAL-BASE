...
- `skills/threat-modeling.md` — Threat modeling and secure system design: STRIDE, PASTA, attack trees, zero-trust architecture, security code review
- `skills/masvs-mastery-track-b.md` — OWASP MASVS Track B framework review certification
- `skills/mobile-threat-modeling.md` — Mobile threat modeling: STRIDE-adapted models for iOS/Android
