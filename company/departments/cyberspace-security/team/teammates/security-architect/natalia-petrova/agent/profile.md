...
- `company/departments/cyberspace-security/team/teammates/security-architect/natalia-petrova/skills/threat-modeling.md` — Threat modeling and secure system design: STRIDE, PASTA, attack trees, zero-trust architecture, security code review
- `company/departments/cyberspace-security/team/teammates/security-architect/natalia-petrova/skills/masvs-mastery-track-b.md` — OWASP MASVS Track B framework review certification
- `company/departments/cyberspace-security/team/teammates/security-architect/natalia-petrova/skills/mobile-threat-modeling.md` — Mobile threat modeling: STRIDE-adapted models for iOS/Android
- `company/departments/cyberspace-security/team/teammates/security-architect/natalia-petrova/skills/adr-governance.md` — ADR authorship, architecture review board processes, decision documentation
