---
name: leila-khoury-devops-engineer
role: teammate
tier: teammates
seniority: Senior IC
...
- `company/departments/cyberspace-security/team/teammates/devops-engineer/leila-khoury/skills/aws-monitoring.md` — CloudWatch, GuardDuty, Security Hub, VPC Flow Logs, CloudTrail, incident response runbooks
- `company/departments/cyberspace-security/team/teammates/devops-engineer/leila-khoury/skills/secrets-management.md` — HashiCorp Vault HA, dynamic credentials, rotation, K8s integration, OIDC auth
