...
- `skills/aws-monitoring.md` — CloudWatch, GuardDuty, Security Hub, VPC Flow Logs, CloudTrail, incident response runbooks
- `skills/secrets-management.md` — HashiCorp Vault HA, dynamic credentials, rotation, K8s integration, OIDC auth
