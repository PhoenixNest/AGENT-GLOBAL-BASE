...
- `skills/android-implementation.md` — Android application development: Jetpack Compose UI, MVVM architecture, Kotlin Coroutines, Hilt DI, Room, Retrofit, platform security, Google Play submission
