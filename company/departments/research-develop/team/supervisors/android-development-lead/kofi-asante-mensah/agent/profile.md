...
- `company/departments/research-develop/team/supervisors/android-development-lead/kofi-asante-mensah/skills/android-implementation.md` — Android application development: Jetpack Compose UI, MVVM architecture, Kotlin Coroutines, Hilt DI, Room, Retrofit, platform security, Google Play submission
