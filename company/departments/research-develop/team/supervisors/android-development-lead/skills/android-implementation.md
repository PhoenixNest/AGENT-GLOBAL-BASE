...
*Note: Specific versions are locked in the Technology Selection Document (TSD) produced at Stage 3. The TSD governs — this skill provides patterns, not version overrides.*
