---
name: elena-vasquez-vp-web-backend
role: supervisor
tier: supervisors
...
- `company/departments/research-develop/team/supervisors/vp-web-backend/skills/distributed-backend-architecture.md` — Distributed systems: microservices design, event-driven architecture (Kafka, gRPC), Kubernetes orchestration, service mesh (Istio), observability
- `company/departments/research-develop/team/supervisors/vp-web-backend/skills/adr-governance.md` — ADR authorship, architecture review board processes, decision documentation
- `company/departments/research-develop/team/supervisors/vp-web-backend/skills/ids-fluency.md` — IDS comprehension, design-engineering feasibility review, design spec interpretation
