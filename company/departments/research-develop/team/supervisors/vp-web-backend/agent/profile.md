...
- `skills/distributed-backend-architecture.md` — Distributed systems: microservices design, event-driven architecture (Kafka, gRPC), Kubernetes orchestration, service mesh (Istio), observability
- `skills/adr-governance.md` — ADR authorship, architecture review board processes, decision documentation
- `skills/ids-fluency.md` — IDS comprehension, design-engineering feasibility review, design spec interpretation
