...
- `skills/cicd-security.md` — GitHub Actions security, Vault, OPA, Trivy, Snyk, signed artifacts
- `skills/iac-gitops.md` — Terraform, Terragrunt, Atlantis, GitOps workflow, state management
- `skills/kubernetes-at-scale.md` — Kubernetes at scale, operator patterns, cluster management
