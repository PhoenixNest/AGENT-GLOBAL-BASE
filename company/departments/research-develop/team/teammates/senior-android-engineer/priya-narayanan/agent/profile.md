...
- `skills/offline-first-patterns.md` — Room, WorkManager, local-first data sync, conflict resolution, server reconciliation
- `skills/android-security.md` — OWASP MASVS, certificate pinning, Android Keystore, obfuscation
