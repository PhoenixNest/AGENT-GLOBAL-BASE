...
- `skills/kotlin-advanced.md` — Kotlin Coroutines, Flow, KMP, structured concurrency
- `skills/android-architecture.md` — MVVM, Clean Architecture, MVI, Android platform internals
- `skills/jetpack-compose.md` — Jetpack Compose UI development, declarative UI patterns
