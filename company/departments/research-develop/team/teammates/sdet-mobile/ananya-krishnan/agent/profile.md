...
- `skills/espresso-xctest.md` — Espresso, XCTest, mobile native test frameworks
- `skills/maestro-testing.md` — Maestro cross-platform E2E, regression testing, test orchestration
- `skills/unit-test-architecture.md` — Unit test architecture, test pyramid design, test suite organization
