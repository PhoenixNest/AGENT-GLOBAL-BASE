---
name: ananya-krishnan-sdet-mobile
role: teammate
tier: teammates
seniority: Senior IC
...
- `company/departments/research-develop/team/teammates/sdet-mobile/ananya-krishnan/skills/espresso-xctest.md` — Espresso, XCTest, mobile native test frameworks
- `company/departments/research-develop/team/teammates/sdet-mobile/ananya-krishnan/skills/maestro-testing.md` — Maestro cross-platform E2E, regression testing, test orchestration
- `company/departments/research-develop/team/teammates/sdet-mobile/ananya-krishnan/skills/unit-test-architecture.md` — Unit test architecture, test pyramid design, test suite organization
