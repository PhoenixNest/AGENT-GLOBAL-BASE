---
name: amara-diallo-senior-ios-engineer
role: teammate
tier: teammates
seniority: Senior IC
...
- `company/departments/research-develop/team/teammates/senior-ios-engineer/amara-diallo/skills/ios-networking.md` — URLSession, request deduplication, retry, caching, GraphQL
- `company/departments/research-develop/team/teammates/senior-ios-engineer/amara-diallo/skills/ios-ci-cd.md` — Bitrise, Fastlane, Firebase Test Lab, snapshot testing, App Store automation
- `company/departments/research-develop/team/teammates/senior-ios-engineer/amara-diallo/skills/combine-reactive-programming.md` — Combine framework, reactive programming patterns
