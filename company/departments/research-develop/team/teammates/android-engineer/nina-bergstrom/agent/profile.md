...
- `skills/android-data-layer.md` — Room, WorkManager, offline-first, conflict resolution
- `skills/android-test-infra.md` — JUnit 5, MockK, Espresso, Maestro E2E testing
