...
- `skills/android-networking.md` — Retrofit, OkHttp, custom interceptors, API resilience
- `skills/android-security-basics.md` — Certificate pinning, encrypted storage, biometric auth, Keystore
