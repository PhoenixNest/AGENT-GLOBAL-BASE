...
- `skills/jetpack-compose.md` — Compose UI, state management, animations, Navigation Compose
- `skills/android-ci-cd.md` — GitHub Actions, Gradle Enterprise, Paparazzi, build optimization
