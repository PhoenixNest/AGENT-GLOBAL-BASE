...
- `skills/go-rest-api.md` — Go concurrency, PostgreSQL, microservices, error handling
- `skills/go-testing.md` — REST API design, OpenAPI 3.0, request validation, pagination
- `skills/go-microservices.md` — Go microservices development, production patterns
