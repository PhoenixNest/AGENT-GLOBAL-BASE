---
name: omar-hassan-backend-engineer
role: teammate
tier: teammates
seniority: Mid IC
...
- `company/departments/research-develop/team/teammates/backend-engineer/omar-hassan/skills/go-rest-api.md` — Go concurrency, PostgreSQL, microservices, error handling
- `company/departments/research-develop/team/teammates/backend-engineer/omar-hassan/skills/go-testing.md` — REST API design, OpenAPI 3.0, request validation, pagination
- `company/departments/research-develop/team/teammates/backend-engineer/omar-hassan/skills/go-microservices.md` — Go microservices development, production patterns
