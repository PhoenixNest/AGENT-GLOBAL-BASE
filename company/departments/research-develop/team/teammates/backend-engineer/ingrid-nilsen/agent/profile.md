...
- `skills/python-fastapi.md` — FastAPI, async Python, Pydantic, PostgreSQL
- `skills/postgresql-basics.md` — Circuit breakers, retry logic, fallback handling, third-party integration
- `skills/postgresql-optimization.md` — PostgreSQL query optimization, indexing, execution plans
