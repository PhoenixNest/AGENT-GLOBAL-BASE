---
name: ingrid-nilsen-backend-engineer
role: teammate
tier: teammates
seniority: Mid IC
...
- `company/departments/research-develop/team/teammates/backend-engineer/ingrid-nilsen/skills/python-fastapi.md` — FastAPI, async Python, Pydantic, PostgreSQL
- `company/departments/research-develop/team/teammates/backend-engineer/ingrid-nilsen/skills/postgresql-basics.md` — Circuit breakers, retry logic, fallback handling, third-party integration
- `company/departments/research-develop/team/teammates/backend-engineer/ingrid-nilsen/skills/postgresql-optimization.md` — PostgreSQL query optimization, indexing, execution plans
