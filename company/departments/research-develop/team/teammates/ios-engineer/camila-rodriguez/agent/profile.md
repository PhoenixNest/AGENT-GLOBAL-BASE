...
- `skills/swiftui.md` — Declarative UI, StateObject, custom transitions, SwiftUI architecture
- `skills/widgetkit-extensions.md` — WidgetKit, App Intents, Share Extension, Today Extension
