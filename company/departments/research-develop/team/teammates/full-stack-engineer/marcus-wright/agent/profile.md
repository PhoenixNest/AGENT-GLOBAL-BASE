---
name: marcus-wright-full-stack-engineer
role: teammate
tier: teammates
seniority: Mid IC
...
- `company/departments/research-develop/team/teammates/full-stack-engineer/marcus-wright/skills/vue-dotnet.md` — Vue 3, .NET 7, Entity Framework Core, multi-tenant architecture
- `company/departments/research-develop/team/teammates/full-stack-engineer/marcus-wright/skills/api-versioning.md` — REST API versioning, rollback, multi-tenant isolation
- `company/departments/research-develop/team/teammates/full-stack-engineer/marcus-wright/skills/multi-tenant-isolation.md` — Multi-tenant data isolation, schema separation, tenant context management
