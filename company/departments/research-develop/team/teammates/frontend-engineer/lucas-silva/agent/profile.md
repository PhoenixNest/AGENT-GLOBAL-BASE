---
name: lucas-silva-frontend-engineer
role: teammate
tier: teammates
seniority: Mid IC
...
- `company/departments/research-develop/team/teammates/frontend-engineer/lucas-silva/skills/vue-vite-advanced.md` — Vue 3, Composition API, Pinia, composables
- `company/departments/research-develop/team/teammates/frontend-engineer/lucas-silva/skills/vue-testing.md` — Vite, build optimization, HMR, code splitting, tree shaking
