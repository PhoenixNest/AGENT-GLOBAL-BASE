...
- `skills/localization-pipeline-engineering.md` — Localization pipeline design and automation: TMS integration, string extraction automation, translated file pull, resource file generation, format validation linting
