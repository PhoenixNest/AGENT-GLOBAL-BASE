...
- `company/departments/localization/team/teammates/english-linguist/skills/mobile-ui-translation.md` — Mobile UI string translation, quality assurance, and style guide application: character limit compliance, platform writing conventions, register calibration, post-editing MT output
