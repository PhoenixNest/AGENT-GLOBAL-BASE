...
- `company/departments/product-management/team/supervisors/vp-product-web-platform/skills/web-product-strategy.md` — (Authored during onboarding Phase 3) End-to-end web product strategy: PWA/Next.js optimization, performance budgets, and browser-native engagement.
- `company/departments/product-management/team/supervisors/vp-product-web-platform/skills/web-accessibility-governance.md` — (Authored during onboarding Phase 3) Implementing and scaling WCAG 2.1 AA standards across the product lifecycle.
