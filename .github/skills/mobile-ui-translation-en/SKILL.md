---
name: mobile-ui-translation-en
description: Mobile UI string translation and quality assurance for English. Covers Language Translation Module workflow, character limit compliance, platform writing conventions (iOS HIG, Android Material Design), register calibration, MT post-editing, and linguistic QA gate before Translation Verification Report.
---

# Mobile UI Translation (English)

## Purpose

Manage English (EN) source strings as the reference language for the handoff package, ensure source string quality, and support the Chief Translation Officer's Translation Verification Report.
...
English requires `one` and `other` plural forms.
