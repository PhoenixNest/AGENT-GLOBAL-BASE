---
name: mobile-ui-translation-ko
description: Mobile UI string translation and quality assurance for Korean. Covers Language Translation Module workflow, character limit compliance, platform writing conventions (iOS HIG, Android Material Design), register calibration, MT post-editing, and linguistic QA gate before Translation Verification Report.
---

# Mobile UI Translation (Korean)

## Purpose

Translate mobile UI strings from the EN-source handoff package into Korean, produce correctly structured platform resource files, and pass the linguistic QA gate before delivery to the Chief Translation Officer for the Translation Verification Report.
...
- Korean typically runs 30–40% longer than English — apply approved brevity techniques; escalate to the CTO-L if a limit is genuinely unachievable
...
- iOS: respect Apple's localization guidelines for Korean
- Android: respect Material Design writing guidelines for Korean
...
Korean has no grammatical plurals — only the `other` quantity form is required.
