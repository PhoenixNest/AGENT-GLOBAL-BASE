...
description: This skill defines the observability and logging architecture for production systems, covering the ELK Stack (Elasticsearch, Logstash, Kibana), Fluentd log collection.
---
