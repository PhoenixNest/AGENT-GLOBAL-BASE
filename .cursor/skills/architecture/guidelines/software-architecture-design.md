...
description: Design scalable, maintainable software architectures for mobile and backend systems. Produce clear architectural documentation including UML diagrams, component designs.
---
