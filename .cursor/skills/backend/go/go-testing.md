---
name: go-testing
description: Implements comprehensive testing strategies for Go applications using table-driven tests, interface mocking with gomock and testify, integration testing with testcontainers.
---
