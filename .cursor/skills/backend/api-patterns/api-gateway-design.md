...
description: Designs and implements API gateway patterns that serve as the single entry point for all client traffic, providing routing, rate limiting, authentication termination.
---
