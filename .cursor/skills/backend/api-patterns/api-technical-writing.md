...
description: Authors and maintains comprehensive API documentation for all platform services, including OpenAPI/Swagger specification documents, endpoint reference documentation.
---
