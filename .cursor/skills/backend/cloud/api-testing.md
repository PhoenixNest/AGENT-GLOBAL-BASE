---
name: api-testing
description: This skill covers comprehensive API testing methodology spanning REST and GraphQL services, authentication and authorization validation (OAuth 2.0, JWT).
---
