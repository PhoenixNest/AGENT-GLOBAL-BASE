...
description: The Combine framework provides a declarative Swift API for processing values over time. It introduces a unified model for handling asynchronous events.
---
...
- `.cursor/skills/ios/swiftui-state-management/` — State management patterns
- `.cursor/skills/ios/data-networking/urlsession-networking/` — Network layer patterns
