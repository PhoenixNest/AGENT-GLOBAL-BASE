...
| ---------------------- | -------------------------------- | ------------------------------------ |
| Testing QA Overview    | `.cursor/skills/testing-qa/`     | Parent skill category                |
| Android Testing        | `.cursor/skills/android/`        | Platform-specific test configuration |
| iOS Testing            | `.cursor/skills/ios/`            | Platform-specific test configuration |
| Cross-Platform Testing | `.cursor/skills/cross-platform/` | KMP/Flutter test strategies          |
| Frontend Web Testing   | `.cursor/skills/frontend-web/`   | Web E2E and component tests          |
| Backend Testing        | `.cursor/skills/backend/`        | API and integration tests            |
| Security               | `.cursor/skills/security/`       | SAST/DAST integration                |
| DevOps                 | `.cursor/skills/devops/`         | Pipeline infrastructure and CI/CD    |
| Shared                 | `.cursor/skills/shared/`         | Cross-cutting TDD practices          |

### Pipeline Document References

| Document               | Location                                            | Purpose                         |
| ---------------------- | --------------------------------------------------- | ------------------------------- |
| Pipeline Definition    | `.cursor/pipeline/mobile-development/pipeline.md`   | 10-stage pipeline specification |
