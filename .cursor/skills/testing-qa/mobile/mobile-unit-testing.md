...
description: Unit testing is the foundation of the mobile test pyramid. This skill provides detailed guidance for writing effective unit tests across Android (Kotlin), iOS (Swift).
---
...
- Stage 7 Pipeline Specification — `.cursor/pipeline/mobile-development/pipeline.md`
