...
| Skill            | Location                         |
| ---------------- | -------------------------------- |
| `android`        | `.cursor/skills/android/`        |
| `ios`            | `.cursor/skills/ios/`            |
| `cross-platform` | `.cursor/skills/cross-platform/` |
| `testing-qa`     | `.cursor/skills/testing-qa/`     |
| `security`       | `.cursor/skills/security/`       |

### 10.3 Pipeline References

| Document                        | Path                                                |
| ------------------------------- | --------------------------------------------------- |
| Pipeline Definition             | `.cursor/pipeline/mobile-development/pipeline.md`   |
