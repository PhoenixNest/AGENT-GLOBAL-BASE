...
| --------------------- | ----------------------------------------------------------- | ------------------------------ |
| Stage 7 Specification | `.cursor/pipeline/mobile-development/pipeline.md`           | Test execution requirements    |
| Stage 8 Specification | `.cursor/pipeline/mobile-development/pipeline.md`           | Integrity verification process |
