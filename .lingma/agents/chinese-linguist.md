...
- `mobile-ui-translation.md` — Mobile UI string translation: Chinese localization, character count optimization, cultural transcreation, MT post-editing, platform formatting validation
