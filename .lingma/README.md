...
├── agents/                      # Lingma SubAgent configurations (77 agents, role-first naming)
│   ├── C-Suite (7 files)
...
│                   ├── translation.md
│                   └── business.md
└── skills/                      # Lingma Skills (14 categories, 199 guidelines)
...
All 77 company personnel are configured as Lingma SubAgents. Each SubAgent file contains:
