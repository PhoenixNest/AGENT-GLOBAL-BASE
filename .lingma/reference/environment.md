...
| Git Bash   | `C:\Program Files\Git\bin\bash.exe`         | Available for general use                                        |
| Shell      | `cmd.exe` (primary), PowerShell (secondary) | Native Windows shells work best                                  |
| Lingma IDE | Local installation                          | Agents and skills enabled, configured in `.lingma/settings.json` |
