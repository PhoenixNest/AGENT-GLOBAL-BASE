---
name: cicd-security
description: Design, implement, and maintain secure CI/CD pipelines that protect the software delivery process from source code commit through production deployment.
---
