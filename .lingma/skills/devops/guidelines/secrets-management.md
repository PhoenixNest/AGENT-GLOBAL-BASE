...
description: Design, implement, and manage enterprise-grade secrets management infrastructure using HashiCorp Vault, covering dynamic credential generation, automated secret rotation.
---
