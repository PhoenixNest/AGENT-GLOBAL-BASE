...
description: This skill implements offline-first architecture patterns using Room database, WorkManager for background synchronization, conflict resolution strategies, and resilient data synchronization.
---
