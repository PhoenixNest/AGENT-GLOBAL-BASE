---
name: vue-vite-advanced
description: This skill provides advanced expertise in Vue 3 Composition API architecture, Vite plugin development and build optimization, Hot Module Replacement (HMR) tuning.
---
