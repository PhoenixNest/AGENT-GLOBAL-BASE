...
| Skill            | Location                         |
| ---------------- | -------------------------------- |
| `android`        | `.lingma/skills/android/`        |
| `ios`            | `.lingma/skills/ios/`            |
| `cross-platform` | `.lingma/skills/cross-platform/` |
| `testing-qa`     | `.lingma/skills/testing-qa/`     |
| `security`       | `.lingma/skills/security/`       |

### 10.3 Pipeline References

| Document                        | Path                                                |
| ------------------------------- | --------------------------------------------------- |
| Pipeline Definition             | `.lingma/pipeline/mobile-development/pipeline.md`   |
