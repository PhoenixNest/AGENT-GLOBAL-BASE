...
| ---------------------- | -------------------------------- | ------------------------------------ |
| Testing QA Overview    | `.lingma/skills/testing-qa/`     | Parent skill category                |
| Android Testing        | `.lingma/skills/android/`        | Platform-specific test configuration |
| iOS Testing            | `.lingma/skills/ios/`            | Platform-specific test configuration |
| Cross-Platform Testing | `.lingma/skills/cross-platform/` | KMP/Flutter test strategies          |
| Frontend Web Testing   | `.lingma/skills/frontend-web/`   | Web E2E and component tests          |
| Backend Testing        | `.lingma/skills/backend/`        | API and integration tests            |
| Security               | `.lingma/skills/security/`       | SAST/DAST integration                |
| DevOps                 | `.lingma/skills/devops/`         | Pipeline infrastructure and CI/CD    |
| Shared                 | `.lingma/skills/shared/`         | Cross-cutting TDD practices          |

### Pipeline Document References

| Document               | Location                                            | Purpose                         |
| ---------------------- | --------------------------------------------------- | ------------------------------- |
| Pipeline Definition    | `.lingma/pipeline/mobile-development/pipeline.md`   | 10-stage pipeline specification |
| Monitoring System      | `company/pipeline/mobile-development/monitoring.md` | Progress tracking and recovery  |
| Defect Severity System | `LINGMA.md`                                         | P0-P3 defect classification     |
