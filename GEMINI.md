...
| **The Company** | `company/`           | Mobile product company simulation     | **Hub:** `company/library/README.md`<br>**Pipeline:** 13-stage (Mobile, Web, Backend API, Full-Stack) with strict approval gates, defect severity rules (P0-P3), and Stage 3 tech lock.<br>**Departments:** Brand Design, Cyberspace Security, HR, Localization, Product Management, R&D. |
