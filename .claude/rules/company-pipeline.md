## Company Pipeline — Always-On Reference

This repository is a **simulated mobile product company**. The following rules are always active:

### Agent Coordination Protocol

You are the **lead agent** (orchestrator). The 11 specialist subagents below are your **Subagents** — each runs in isolated context and returns results to you. Coordinate them per their pipeline stage ownership.
...
Use `@<agent-name>` to @-mention a specific subagent.
