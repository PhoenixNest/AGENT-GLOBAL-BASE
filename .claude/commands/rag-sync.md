Read the file `core-component-00/platform/model-context-protocol-servers/workspace-knowledge/rag-system/rag-sync-state.json`. If it does not exist, treat the
