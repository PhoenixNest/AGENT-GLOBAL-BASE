---
name: company-vet-candidate
description: Elite candidate vetting gate — 20-point scoring system (Impact at Scale, Craft Depth, Leadership Signal, Standards Signal, Red Flag Scan) applied to every recruitment candidate. Must be run before any hire is confirmed. Owned by Dr. Evelyn Hartwell (CHRO).
