---
name: company-mobile-design-systems
description: Mobile design system creation — platform-specific component libraries for iOS (HIG) and Android (Material Design), interaction patterns, design tokens, accessibility standards (WCAG 2.1 AA), design-to-production workflow. Owned by Yuki Tanaka-Chen (CDO).
