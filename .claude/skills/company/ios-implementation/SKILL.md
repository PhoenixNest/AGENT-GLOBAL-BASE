---
name: company-ios-implementation
description: iOS application development — SwiftUI, Swift Concurrency (async/await, actors), MVVM architecture, Keychain security, CoreData, URLSession with certificate pinning, App Store Connect submission. Owned by Seo-Yeon Park (iOS Lead).
