---
name: company-uml-engineering-package
description: UML Engineering Package production — class, sequence, and component diagram authorship using PlantUML/Mermaid, zero-ambiguity architecture documentation standards traceable from product requirements to architectural choice. Owned by Rafael Okonkwo (Software Architect).
