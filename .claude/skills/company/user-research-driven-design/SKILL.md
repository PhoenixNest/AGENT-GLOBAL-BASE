---
name: company-user-research-driven-design
description: Research-backed design decisions for mobile — usability testing, A/B experiments, qualitative research, diary studies, longitudinal cohort analysis, data-informed design iteration. Owned by Yuki Tanaka-Chen (CDO).
