---
name: company-mobile-architecture-patterns
description: Cross-platform mobile architecture patterns — clean architecture, KMP shared-core, VIPER, The Composable Architecture (TCA), MVVM, dependency injection, monorepo modularisation, logical project structure design. Owned by Rafael Okonkwo (Software Architect).
