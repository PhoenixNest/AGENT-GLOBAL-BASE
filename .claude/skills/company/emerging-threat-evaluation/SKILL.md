---
name: company-emerging-threat-evaluation
description: Emerging technology security evaluation — threat intelligence, identifying security risks 6–12 months before mainstream, quarterly Mobile Threat Landscape assessment, new technology risk identification. Owned by Dr. Sarah Chen (CSO).
...
**With CIO:** Align security evaluation with technology strategy — no technology is adopted without a parallel security evaluation.

**With CTO:** Integrate security requirements into architecture decisions before Stage 3 locks technology choices.

**With Product:** Balance innovation with security risk tolerance — new capabilities are assessed 6–12 months before mainstream adoption so product decisions are made with full security context.
