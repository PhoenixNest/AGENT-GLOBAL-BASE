---
name: company-android-implementation
description: Android application development — Jetpack Compose UI, MVVM + StateFlow + Repository architecture, Kotlin Coroutines, Hilt DI, Room, Retrofit, platform security (Keystore, EncryptedSharedPreferences), Google Play submission. Owned by Kofi Asante-Mensah (Android Lead).
