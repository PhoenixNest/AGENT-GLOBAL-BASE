---
name: company-technical-selection-documentation
description: High-quality technical selection documents, version analysis reports, and Architecture Decision Records (ADRs) — TCO analysis, migration risk matrices, vendor lock-in assessment, explicit success/failure criteria, executive-grade clarity. Owned by Dr. Priya Mehta (CIO).
...
**Length:** 800-1200 words | **Audience:** C-suite, VP-level
...
**Length:** 600-800 words | **Audience:** Engineering leadership, Product leadership
...
**Length:** 400-600 words | **Audience:** Engineering team, future maintainers
