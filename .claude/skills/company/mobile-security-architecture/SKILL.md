---
name: company-mobile-security-architecture
description: Mobile platform security architecture for iOS and Android — Secure Enclave, Keychain, Android Keystore, SafetyNet, ATS, certificate pinning, encryption, biometric authentication, OWASP MASVS compliance. Owned by Dr. Sarah Chen (CSO).
