---
name: company-recruit-data
description: Data science, ML, and analytics role recruitment — Interview Simulation Protocol for data scientists, ML engineers, analytics engineers. Owned by Dr. Evelyn Hartwell (CHRO).
...
| Research depth  | None required          | Applied research                | Novel approaches within domain      | Published or patented methods | Production-scale ML research  | Original research, published or patent-pending      | N/A                         | N/A                          | Industry thought leadership |
...
2. Create at least one `team/[tier]/[role-name]/skills/[skill-name].md` (e.g., `ml-modeling.md`, `data-strategy.md`)
