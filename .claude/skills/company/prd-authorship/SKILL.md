---
name: company-prd-authorship
description: High-quality PRD authorship for mobile products — problem framing with JTBD, platform-specific UX constraints, instrumented metric definitions, edge case matrices, technical feasibility pre-assessment, launch sequencing, and explicit success/failure criteria. Owned by Marcus Tran-Yoshida (CPO).
