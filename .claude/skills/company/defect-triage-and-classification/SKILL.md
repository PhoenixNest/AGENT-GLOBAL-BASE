---
name: company-defect-triage-and-classification
description: P0–P3 defect classification system for mobile — severity decision trees for ambiguous cases, escalation protocols for P0/P1 release blockers, user-decision gates for P2/P3 deferrals, remediation tracking. P0/P1 are non-negotiable release blockers. Owned by Priscilla Oduya (Test Lead).
