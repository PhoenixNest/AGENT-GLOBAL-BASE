---
name: company-kmp-implementation
description: Kotlin Multiplatform (KMP) implementation — shared module architecture, expect/actual patterns, Ktor shared networking, SQLDelight database, Swift interoperability, Kotlin/Native memory model, Gradle multi-module KMP build. Owned by Mei-Ling Johansson (Cross-Platform Lead).
