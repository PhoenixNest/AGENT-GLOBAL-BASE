---
name: company-design-to-engineering-handoff
description: Design-engineering collaboration — technical design specs, implementation feasibility assessment, handoff documentation that eliminates ambiguity, component trees, state diagrams, gesture conflict resolution. Owned by Yuki Tanaka-Chen (CDO).
...
3. **Spec Finalization** → Lock specifications
