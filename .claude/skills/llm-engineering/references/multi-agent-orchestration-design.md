...
`core-component-00/framework/05-multi-agent-engineering/`.
...
| `core-component-00/framework/05-multi-agent-engineering/fundamentals/git-worktree-orchestration.md` | Parallel agent isolation using git worktrees |
| `core-component-00/framework/02-context-engineering/patterns/multi-agent-handoff.md`                | Context Handoff Protocol tiers               |
| `core-component-00/framework/05-multi-agent-engineering/implementations/swarm_orchestrator.py`      | Reference orchestrator implementation        |
| `core-component-00/framework/05-multi-agent-engineering/implementations/handoff_packet.py`          | Handoff packet construction                  |
...
`framework/05-multi-agent-engineering/patterns/orchestration-patterns.md`
...
Reference: `framework/02-context-engineering/patterns/multi-agent-handoff.md`
...
`framework/05-multi-agent-engineering/patterns/anti-patterns.md`.
