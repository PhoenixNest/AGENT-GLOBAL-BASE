...
- **ASGF compliance:** Validates all deliverables against `core-component-00/framework/00-agent-systems-governance-framework/governance/compliance-standard.md`
