...
├── agents/                      # OpenCode SubAgent configurations (77 agents, role-first naming)
│   ├── C-Suite (7 files)
...
│                   ├── translation.md
│                   └── business.md
└── skills/                      # OpenCode Skills (14 categories, 213 guidelines)
...
All 77 company personnel are configured as OpenCode SubAgents. Each SubAgent file contains:

- **YAML frontmatter** with `description`, `mode`, and `tools` object
