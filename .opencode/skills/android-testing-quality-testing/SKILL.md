---
name: android-testing-quality-testing
description: Android testing practices — TDD methodology, JUnit 5 unit testing with MockK, Compose UI testing, Robolectric JVM-based tests, Espresso instrumented tests, and test factory architecture. Owned by Sofia Rezende (Senior Android Engineer). Use during Stage 5 (Development) for TDD and Stage 7 (Automated Testing) for 100% test pass rate enforcement. Trigger: android testing, TDD, junit 5, mockk, compose testing, robolectric, espresso, unit testing, UI testing, test coverage.
prerequisites:
