---
name: security-compliance-documentation
description: Compliance documentation for mobile products — security policy authorship, data processing agreements, privacy impact assessments, compliance evidence packaging, and regulatory submission preparation for App Store and Google Play. Owned by Ingrid Solberg (Security Engineer). Use during Stage 1 (Requirements) for compliance documentation planning and Stage 10 (Release Readiness) for compliance package assembly. Trigger: compliance documentation, security policy, data processing agreement, privacy impact assessment, compliance evidence, regulatory submission, App Store compliance, Google Play compliance.
prerequisites:
  - security-overview
