---
name: testing-qa-mobile-test-automation
description: Mobile test automation strategy — test framework selection, CI/CD integration patterns, test data management, flaky test mitigation, test reporting dashboards, and automation ROI measurement for iOS and Android pipelines. Owned by Rachel Kim (Test Automation Lead). Use during Stage 4 (Implementation Plan) for automation strategy design and Stage 7 (Testing) for automation execution. Trigger: mobile test automation, test framework selection, CI/CD test integration, test data management, flaky test mitigation, test reporting, automation ROI.
prerequisites:
  - testing-qa-overview
