---
name: android-ui-ux-accessibility
description: Android accessibility (a11y) engineering — WCAG 2.1 AA compliance, TalkBack optimization with ContentDescription and custom accessibility actions, dynamic font scaling (200%), touch target sizing (48dp), and automated accessibility testing with Espresso a11y checks. Owned by Sofia Rezende (Senior Android Engineer). Use during Stage 5 (Development) for accessible UI implementation and Stage 8 (Integrity Verification) for IDS accessibility conformance. Trigger: android accessibility, WCAG 2.1 AA, TalkBack, content description, font scaling, touch target, accessibility testing, screen reader, a11y.
prerequisites:
  - android-ui-ux-jetpack-compose
