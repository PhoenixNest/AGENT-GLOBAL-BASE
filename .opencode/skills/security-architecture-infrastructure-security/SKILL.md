...
description: Infrastructure security for mobile backends — network segmentation, zero-trust architecture, API gateway security, database encryption, and cloud security posture management (CSPM) for mobile service infrastructure. Owned by Elin Ström (Security Engineer). Use during Stage 3 (UML Engineering) for infrastructure security architecture and Stage 5 (Development) for security implementation. Trigger: infrastructure security, network segmentation, zero-trust, API gateway security, database encryption, CSPM, cloud security posture, mobile backend security.
prerequisites:
  - security-overview
...
This skill defines the runtime security and infrastructure hardening practices for containerized and cloud-native environments, covering Falco runtime security monitoring, OSQuery host-based investigation, container image scanning, network anomaly detection, and security event correlation. Infrastructure security operates at the platform layer, providing continuous monitoring and automated response capabilities that complement application-level security controls.
