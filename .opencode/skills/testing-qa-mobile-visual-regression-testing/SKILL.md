...
| --------------------- | ----------------------------------------------------------- | ------------------------------ |
| Stage 7 Specification | `.opencode/pipeline/mobile-development/pipeline.md`         | Test execution requirements    |
| Stage 8 Specification | `.opencode/pipeline/mobile-development/pipeline.md`         | Integrity verification process |
| Defect Classification | `AGENTS.md`                                                 | P0-P3 severity system          |
