---
name: cross-platform-flutter-implementation
description: Flutter application implementation — Dart, widget architecture, Riverpod state management, platform channels for native API access, custom design systems, App Store and Google Play submission. Owned by Mei-Ling Johansson (Cross-Platform Lead). Use during Stage 5 (Development) for Flutter track implementation and Stage 10 (Release Readiness) for store submission. Trigger: Flutter implementation, Dart coding, Flutter widgets, Riverpod, platform channels, Flutter deployment.
prerequisites:
...
// app_en.arb
{
  ...
  "@checkoutConfirmButton": {
    "description": "Button label on the checkout screen. Appears after payment method is selected."
  },
