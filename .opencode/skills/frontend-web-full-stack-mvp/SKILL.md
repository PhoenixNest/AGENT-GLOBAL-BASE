---
name: frontend-web-full-stack-mvp
description: Full-stack MVP development with React + Node.js + PostgreSQL — Docker Compose local environments, feature flag strategies, MVP scoping frameworks, and rapid end-to-end delivery pipelines. Owned by Amira Voss (Frontend Chapter Lead). Use during Stage 4 (Implementation Plan) for MVP scoping and Stage 5 (Development) for rapid prototyping. Trigger: full-stack mvp, react nodejs mvp, rapid prototyping, feature flags, mvp scoping, docker compose development.
prerequisites:
